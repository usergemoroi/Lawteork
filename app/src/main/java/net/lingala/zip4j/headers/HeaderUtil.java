...
public class HeaderUtil {
    public static FileHeader getFileHeader(ZipModel zipModel, String fileName) throws ZipException {
        ...
        if (fileHeader == null) {
            ...
            FileHeader fileHeader2 = getFileHeaderWithExactMatch(zipModel, fileName2);
            if (fileHeader2 == null) {
                return getFileHeaderWithExactMatch(zipModel, fileName2.replaceAll(InternalZipConstants.ZIP_FILE_SEPARATOR, "\\\\"));
            }
            return fileHeader2;
        }
        return fileHeader;
