...
public class CutoutDrawable extends MaterialShapeDrawable {
    ...
    void setCutout(float left, float top2, float right, float bottom) {
        if (left == this.drawableState.cutoutBounds.left && top2 == this.drawableState.cutoutBounds.top && right == this.drawableState.cutoutBounds.right && bottom == this.drawableState.cutoutBounds.bottom) {
            return;
        }
        this.drawableState.cutoutBounds.set(left, top2, right, bottom);
        invalidateSelf();
    }
