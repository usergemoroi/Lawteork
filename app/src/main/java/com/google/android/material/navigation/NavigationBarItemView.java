...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C0605R.C0608id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C0605R.C0608id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C0605R.C0608id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C0605R.C0608id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C0605R.C0608id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0605R.C0608id.navigation_bar_item_large_label_view);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float newProgress) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0605R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0605R.attr.motionDurationLong2, getResources().getInteger(C0605R.integer.material_motion_duration_long_1)));
    ...
    protected int getItemBackgroundResId() {
        return C0605R.C0607drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C0605R.dimen.mtrl_navigation_bar_item_default_margin;
    }
