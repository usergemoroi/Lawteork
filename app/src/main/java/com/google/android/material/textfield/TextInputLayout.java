...
public class TextInputLayout extends LinearLayout {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.textInputStyle);
    }
    ...
    */
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0605R.styleable.TextInputLayout, defStyleAttr, i2, C0605R.styleable.TextInputLayout_counterTextAppearance, C0605R.styleable.TextInputLayout_counterOverflowTextAppearance, C0605R.styleable.TextInputLayout_errorTextAppearance, C0605R.styleable.TextInputLayout_helperTextTextAppearance, C0605R.styleable.TextInputLayout_hintTextAppearance);
        StartCompoundLayout startCompoundLayout = new StartCompoundLayout(this, a);
        this.startLayout = startCompoundLayout;
        this.hintEnabled = a.getBoolean(C0605R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0605R.styleable.TextInputLayout_android_hint));
        this.hintAnimationEnabled = a.getBoolean(C0605R.styleable.TextInputLayout_hintAnimationEnabled, true);
        this.expandedHintEnabled = a.getBoolean(C0605R.styleable.TextInputLayout_expandedHintEnabled, true);
        if (a.hasValue(C0605R.styleable.TextInputLayout_android_minEms)) {
            setMinEms(a.getInt(C0605R.styleable.TextInputLayout_android_minEms, -1));
        } else if (a.hasValue(C0605R.styleable.TextInputLayout_android_minWidth)) {
            setMinWidth(a.getDimensionPixelSize(C0605R.styleable.TextInputLayout_android_minWidth, -1));
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_android_maxEms)) {
            setMaxEms(a.getInt(C0605R.styleable.TextInputLayout_android_maxEms, -1));
        } else if (a.hasValue(C0605R.styleable.TextInputLayout_android_maxWidth)) {
            setMaxWidth(a.getDimensionPixelSize(C0605R.styleable.TextInputLayout_android_maxWidth, -1));
        }
        this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, i2).build();
        this.boxLabelCutoutPaddingPx = context2.getResources().getDimensionPixelOffset(C0605R.dimen.mtrl_textinput_box_label_cutout_padding);
        this.boxCollapsedPaddingTopPx = a.getDimensionPixelOffset(C0605R.styleable.TextInputLayout_boxCollapsedPaddingTop, 0);
        this.boxStrokeWidthDefaultPx = a.getDimensionPixelSize(C0605R.styleable.TextInputLayout_boxStrokeWidth, context2.getResources().getDimensionPixelSize(C0605R.dimen.mtrl_textinput_box_stroke_width_default));
        this.boxStrokeWidthFocusedPx = a.getDimensionPixelSize(C0605R.styleable.TextInputLayout_boxStrokeWidthFocused, context2.getResources().getDimensionPixelSize(C0605R.dimen.mtrl_textinput_box_stroke_width_focused));
        this.boxStrokeWidthPx = this.boxStrokeWidthDefaultPx;
        float boxCornerRadiusTopStart = a.getDimension(C0605R.styleable.TextInputLayout_boxCornerRadiusTopStart, -1.0f);
        float boxCornerRadiusTopEnd = a.getDimension(C0605R.styleable.TextInputLayout_boxCornerRadiusTopEnd, -1.0f);
        float boxCornerRadiusBottomEnd = a.getDimension(C0605R.styleable.TextInputLayout_boxCornerRadiusBottomEnd, -1.0f);
        float boxCornerRadiusBottomStart = a.getDimension(C0605R.styleable.TextInputLayout_boxCornerRadiusBottomStart, -1.0f);
        ...
        ColorStateList filledBackgroundColorStateList = MaterialResources.getColorStateList(context2, a, C0605R.styleable.TextInputLayout_boxBackgroundColor);
        if (filledBackgroundColorStateList == null) {
            ...
            if (filledBackgroundColorStateList.isStateful()) {
                ...
                ColorStateList mtrlFilledBackgroundColorStateList = AppCompatResources.getColorStateList(context2, C0605R.C0606color.mtrl_filled_background_color);
        ...
        if (a.hasValue(C0605R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0605R.styleable.TextInputLayout_android_textColorHint);
            this.focusedTextColor = colorStateList;
            this.defaultHintTextColor = colorStateList;
        }
        ColorStateList boxStrokeColorStateList = MaterialResources.getColorStateList(context2, a, C0605R.styleable.TextInputLayout_boxStrokeColor);
        this.focusedStrokeColor = a.getColor(C0605R.styleable.TextInputLayout_boxStrokeColor, 0);
        this.defaultStrokeColor = ContextCompat.getColor(context2, C0605R.C0606color.mtrl_textinput_default_box_stroke_color);
        this.disabledColor = ContextCompat.getColor(context2, C0605R.C0606color.mtrl_textinput_disabled_color);
        this.hoveredStrokeColor = ContextCompat.getColor(context2, C0605R.C0606color.mtrl_textinput_hovered_box_stroke_color);
        if (boxStrokeColorStateList != null) {
            setBoxStrokeColorStateList(boxStrokeColorStateList);
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_boxStrokeErrorColor)) {
            setBoxStrokeErrorColor(MaterialResources.getColorStateList(context2, a, C0605R.styleable.TextInputLayout_boxStrokeErrorColor));
        }
        int hintAppearance = a.getResourceId(C0605R.styleable.TextInputLayout_hintTextAppearance, -1);
        if (hintAppearance != -1) {
            i = 0;
            setHintTextAppearance(a.getResourceId(C0605R.styleable.TextInputLayout_hintTextAppearance, 0));
        } else {
            i = 0;
        }
        int errorTextAppearance = a.getResourceId(C0605R.styleable.TextInputLayout_errorTextAppearance, i);
        CharSequence errorContentDescription = a.getText(C0605R.styleable.TextInputLayout_errorContentDescription);
        int errorAccessibilityLiveRegion = a.getInt(C0605R.styleable.TextInputLayout_errorAccessibilityLiveRegion, 1);
        boolean errorEnabled = a.getBoolean(C0605R.styleable.TextInputLayout_errorEnabled, false);
        int helperTextTextAppearance = a.getResourceId(C0605R.styleable.TextInputLayout_helperTextTextAppearance, 0);
        boolean helperTextEnabled = a.getBoolean(C0605R.styleable.TextInputLayout_helperTextEnabled, false);
        CharSequence helperText = a.getText(C0605R.styleable.TextInputLayout_helperText);
        int placeholderTextAppearance = a.getResourceId(C0605R.styleable.TextInputLayout_placeholderTextAppearance, 0);
        CharSequence placeholderText = a.getText(C0605R.styleable.TextInputLayout_placeholderText);
        boolean counterEnabled = a.getBoolean(C0605R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0605R.styleable.TextInputLayout_counterMaxLength, -1));
        this.counterTextAppearance = a.getResourceId(C0605R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.counterOverflowTextAppearance = a.getResourceId(C0605R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        setBoxBackgroundMode(a.getInt(C0605R.styleable.TextInputLayout_boxBackgroundMode, 0));
        ...
        if (a.hasValue(C0605R.styleable.TextInputLayout_errorTextColor)) {
            setErrorTextColor(a.getColorStateList(C0605R.styleable.TextInputLayout_errorTextColor));
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_helperTextTextColor)) {
            setHelperTextColor(a.getColorStateList(C0605R.styleable.TextInputLayout_helperTextTextColor));
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_hintTextColor)) {
            setHintTextColor(a.getColorStateList(C0605R.styleable.TextInputLayout_hintTextColor));
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_counterTextColor)) {
            setCounterTextColor(a.getColorStateList(C0605R.styleable.TextInputLayout_counterTextColor));
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_counterOverflowTextColor)) {
            setCounterOverflowTextColor(a.getColorStateList(C0605R.styleable.TextInputLayout_counterOverflowTextColor));
        }
        if (a.hasValue(C0605R.styleable.TextInputLayout_placeholderTextColor)) {
            setPlaceholderTextColor(a.getColorStateList(C0605R.styleable.TextInputLayout_placeholderTextColor));
        }
        EndCompoundLayout endCompoundLayout = new EndCompoundLayout(this, a);
        this.endLayout = endCompoundLayout;
        boolean enabled = a.getBoolean(C0605R.styleable.TextInputLayout_android_enabled, true);
        a.recycle();
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        int rippleColor = MaterialColors.getColor(this.editText, C0605R.attr.colorControlHighlight);
        int i = this.boxBackgroundMode;
        if (i == 2) {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable boxBackground, int rippleColor, int[][] states) {
        int surfaceColor = MaterialColors.getColor(context, C0605R.attr.colorSurface, LOG_TAG);
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean roundedTopCorners) {
        float elevation;
        float cornerRadius = getResources().getDimensionPixelOffset(C0605R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (editText instanceof MaterialAutoCompleteTextView) {
            ...
            elevation = getResources().getDimensionPixelOffset(C0605R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int verticalPadding = getResources().getDimensionPixelOffset(C0605R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0605R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0605R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            EditText editText = this.editText;
            ViewCompat.setPaddingRelative(editText, ViewCompat.getPaddingStart(editText), getResources().getDimensionPixelSize(C0605R.dimen.material_filled_edittext_font_2_0_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0605R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            EditText editText2 = this.editText;
            ViewCompat.setPaddingRelative(editText2, ViewCompat.getPaddingStart(editText2), getResources().getDimensionPixelSize(C0605R.dimen.material_filled_edittext_font_1_3_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0605R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.counterEnabled != enabled) {
            if (!enabled) {
                ...
                appCompatTextView.setId(C0605R.C0608id.textinput_counter);
                ...
                MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(C0605R.dimen.mtrl_textinput_counter_margin_start));
    ...
    void updateCounter(Editable text) {
        ...
        if (i == -1) {
            ...
            this.counterView.setText(bidiFormatter.unicodeWrap(getContext().getString(C0605R.string.character_counter_pattern, Integer.valueOf(length), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView counterView, int length, int counterMaxLength, boolean counterOverflowed) {
        ...
        if (counterOverflowed) {
            i = C0605R.string.character_counter_overflowed_content_description;
        } else {
            i = C0605R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence placeholderText) {
        if (this.placeholderTextView == null) {
            ...
            appCompatTextView.setId(C0605R.C0608id.textinput_placeholder);
    ...
    private Fade createPlaceholderFadeTransition() {
        ...
        placeholderFadeTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0605R.attr.motionDurationShort2, 87));
        placeholderFadeTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0605R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
    ...
    public void setTextAppearanceCompatWithErrorFallback(TextView textView, int textAppearance) {
        ...
        if (useDefaultColor) {
            TextViewCompat.setTextAppearance(textView, C0605R.style.TextAppearance_AppCompat_Caption);
            textView.setTextColor(ContextCompat.getColor(getContext(), C0605R.C0606color.design_error));
        }
    }
    ...
    private int calculateBoxBackgroundColor() {
        ...
        if (this.boxBackgroundMode == 1) {
            int surfaceLayerColor = MaterialColors.getColor(this, C0605R.attr.colorSurface, 0);
    ...
    private void updateBoxUnderlineBounds(Rect bounds) {
        if (this.boxUnderlineDefault != null) {
            int top2 = bounds.bottom - this.boxStrokeWidthDefaultPx;
            this.boxUnderlineDefault.setBounds(bounds.left, top2, bounds.right, bounds.bottom);
        }
        if (this.boxUnderlineFocused != null) {
            int top3 = bounds.bottom - this.boxStrokeWidthFocusedPx;
            this.boxUnderlineFocused.setBounds(bounds.left, top3, bounds.right, bounds.bottom);
        }
    }
    ...
    private void updateCursorColor(boolean isOnError) {
        ColorStateList cursorColor = MaterialColors.getColorStateListOrNull(getContext(), C0605R.attr.colorControlActivated);
        EditText editText = this.editText;
    ...
    void animateToExpansionFraction(float target) {
        ...
        if (this.animator == null) {
            ...
            valueAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0605R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0605R.attr.motionDurationMedium4, LABEL_SCALE_ANIMATION_DURATION));
