...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C0605R.attr.colorError, C0605R.attr.colorOnError, C0605R.attr.colorErrorContainer, C0605R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C0605R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
