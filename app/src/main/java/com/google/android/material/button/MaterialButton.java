...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_MaterialComponents_Button;
    ...
    public MaterialButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.materialButtonStyle);
    }
    ...
    */
    public MaterialButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.MaterialButton, defStyleAttr, i, new int[0]);
        this.iconPadding = attributes.getDimensionPixelSize(C0605R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(attributes.getInt(C0605R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), attributes, C0605R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), attributes, C0605R.styleable.MaterialButton_icon);
        this.iconGravity = attributes.getInteger(C0605R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = attributes.getDimensionPixelSize(C0605R.styleable.MaterialButton_iconSize, 0);
