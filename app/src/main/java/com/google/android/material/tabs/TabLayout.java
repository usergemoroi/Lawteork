...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.tabStyle);
    }
    ...
    */
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.TabLayout, defStyleAttr, i, C0605R.styleable.TabLayout_tabTextAppearance);
        ...
        setSelectedTabIndicator(MaterialResources.getDrawable(context2, a, C0605R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorColor(a.getColor(C0605R.styleable.TabLayout_tabIndicatorColor, 0));
        slidingTabIndicator.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabIndicatorHeight, -1));
        setSelectedTabIndicatorGravity(a.getInt(C0605R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorAnimationMode(a.getInt(C0605R.styleable.TabLayout_tabIndicatorAnimationMode, 0));
        setTabIndicatorFullWidth(a.getBoolean(C0605R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        if (ThemeEnforcement.isMaterial3Theme(context2)) {
            this.defaultTabTextAppearance = C0605R.attr.textAppearanceTitleSmall;
        } else {
            this.defaultTabTextAppearance = C0605R.attr.textAppearanceButton;
        }
        int resourceId = a.getResourceId(C0605R.styleable.TabLayout_tabTextAppearance, C0605R.style.TextAppearance_Design_Tab);
        this.tabTextAppearance = resourceId;
        TypedArray selectedTabTA = context2.obtainStyledAttributes(resourceId, C0030R.styleable.TextAppearance);
        try {
            this.tabTextSize = selectedTabTA.getDimensionPixelSize(C0030R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context2, selectedTabTA, C0030R.styleable.TextAppearance_android_textColor);
            selectedTabTA.recycle();
            if (a.hasValue(C0605R.styleable.TabLayout_tabSelectedTextAppearance)) {
                this.selectedTabTextAppearance = a.getResourceId(C0605R.styleable.TabLayout_tabSelectedTextAppearance, resourceId);
            }
            int i2 = this.selectedTabTextAppearance;
            if (i2 != -1) {
                selectedTabTA = context2.obtainStyledAttributes(i2, C0030R.styleable.TextAppearance);
                try {
                    this.selectedTabTextSize = selectedTabTA.getDimensionPixelSize(C0030R.styleable.TextAppearance_android_textSize, (int) this.tabTextSize);
                    ColorStateList selectedTabTextColor = MaterialResources.getColorStateList(context2, selectedTabTA, C0030R.styleable.TextAppearance_android_textColor);
            ...
            if (a.hasValue(C0605R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context2, a, C0605R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0605R.styleable.TabLayout_tabSelectedTextColor)) {
                int selected = a.getColor(C0605R.styleable.TabLayout_tabSelectedTextColor, 0);
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), selected);
            }
            int selected2 = C0605R.styleable.TabLayout_tabIconTint;
            this.tabIconTint = MaterialResources.getColorStateList(context2, a, selected2);
            this.tabIconTintMode = ViewUtils.parseTintMode(a.getInt(C0605R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context2, a, C0605R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = a.getInt(C0605R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.tabIndicatorTimeInterpolator = MotionUtils.resolveThemeInterpolator(context2, C0605R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            this.requestedTabMinWidth = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = a.getResourceId(C0605R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = a.getDimensionPixelSize(C0605R.styleable.TabLayout_tabContentStart, 0);
            this.mode = a.getInt(C0605R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = a.getInt(C0605R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = a.getBoolean(C0605R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = a.getBoolean(C0605R.styleable.TabLayout_tabUnboundedRipple, false);
            a.recycle();
            Resources res = getResources();
            this.tabTextMultiLineSize = res.getDimensionPixelSize(C0605R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = res.getDimensionPixelSize(C0605R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
        }
    }
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            infoCompat.setRoleDescription(getResources().getString(C0605R.string.item_view_role_description));
        }
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0605R.layout.design_layout_tab_icon, iconViewParent, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0605R.layout.design_layout_tab_text, textViewParent, false);
