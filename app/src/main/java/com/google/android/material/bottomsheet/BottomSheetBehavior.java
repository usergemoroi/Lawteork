...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_Design_BottomSheet_Modal;
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
            ...
            public void onViewPositionChanged(View changedView, int left, int top2, int dx, int dy) {
                BottomSheetBehavior.this.dispatchOnSlide(top2);
            }
            ...
            public int clampViewPositionVertical(View child, int top2, int dy) {
                return MathUtils.clamp(top2, BottomSheetBehavior.this.getExpandedOffset(), getViewVerticalDragRange(child));
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        this.peekHeightGestureInsetBuffer = context.getResources().getDimensionPixelSize(C0605R.dimen.mtrl_min_touch_target_size);
        TypedArray a = context.obtainStyledAttributes(attrs, C0605R.styleable.BottomSheetBehavior_Layout);
        if (a.hasValue(C0605R.styleable.BottomSheetBehavior_Layout_backgroundTint)) {
            this.backgroundTint = MaterialResources.getColorStateList(context, a, C0605R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        }
        if (a.hasValue(C0605R.styleable.BottomSheetBehavior_Layout_shapeAppearance)) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attrs, C0605R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
        }
        createMaterialShapeDrawableIfNeeded(context);
        createShapeValueAnimator();
        this.elevation = a.getDimension(C0605R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        if (a.hasValue(C0605R.styleable.BottomSheetBehavior_Layout_android_maxWidth)) {
            setMaxWidth(a.getDimensionPixelSize(C0605R.styleable.BottomSheetBehavior_Layout_android_maxWidth, -1));
        }
        if (a.hasValue(C0605R.styleable.BottomSheetBehavior_Layout_android_maxHeight)) {
            setMaxHeight(a.getDimensionPixelSize(C0605R.styleable.BottomSheetBehavior_Layout_android_maxHeight, -1));
        }
        TypedValue value = a.peekValue(C0605R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (value != null && value.data == -1) {
            setPeekHeight(value.data);
        } else {
            setPeekHeight(a.getDimensionPixelSize(C0605R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        }
        setHideable(a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setGestureInsetBottomIgnored(a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false));
        setFitToContents(a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setDraggable(a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_behavior_draggable, true));
        setSaveFlags(a.getInt(C0605R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(a.getFloat(C0605R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, 0.5f));
        TypedValue value2 = a.peekValue(C0605R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset);
        if (value2 != null && value2.type == 16) {
            setExpandedOffset(value2.data);
        } else {
            setExpandedOffset(a.getDimensionPixelOffset(C0605R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        }
        setSignificantVelocityThreshold(a.getInt(C0605R.styleable.BottomSheetBehavior_Layout_behavior_significantVelocityThreshold, 500));
        this.paddingBottomSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_paddingRightSystemWindowInsets, false);
        this.paddingTopSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_paddingTopSystemWindowInsets, true);
        this.marginLeftSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_marginLeftSystemWindowInsets, false);
        this.marginRightSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_marginRightSystemWindowInsets, false);
        this.marginTopSystemWindowInsets = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_marginTopSystemWindowInsets, false);
        this.shouldRemoveExpandedCorners = a.getBoolean(C0605R.styleable.BottomSheetBehavior_Layout_shouldRemoveExpandedCorners, true);
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = parent.getResources().getDimensionPixelSize(C0605R.dimen.design_bottom_sheet_peek_height_min);
    ...
    private float calculateSlideOffsetWithTop(int top2) {
        int i = this.collapsedOffset;
        if (top2 > i || i == getExpandedOffset()) {
            int i2 = this.collapsedOffset;
            return (i2 - top2) / (this.parentHeight - i2);
        }
        int i3 = this.collapsedOffset;
        return (i3 - top2) / (i3 - getExpandedOffset());
    }
    ...
    private void setWindowInsetsListener(View child) {
        ...
        ViewUtils.doOnApplyWindowInsets(child, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat insets, ViewUtils.RelativePadding initialPadding) {
                ...
                BottomSheetBehavior.this.insetTop = systemBarInsets.f255top;
                ...
                if (BottomSheetBehavior.this.marginTopSystemWindowInsets && mlp.topMargin != systemBarInsets.f255top) {
                    mlp.topMargin = systemBarInsets.f255top;
                    marginUpdated = true;
                }
                if (marginUpdated) {
    ...
    public void startSettling(View child, int state, boolean isReleasingView) {
        int top2 = getTopOffsetForState(state);
        ViewDragHelper viewDragHelper = this.viewDragHelper;
        boolean settling = viewDragHelper != null && (!isReleasingView ? !viewDragHelper.smoothSlideViewTo(child, child.getLeft(), top2) : !viewDragHelper.settleCapturedViewAt(child.getLeft(), top2));
        if (settling) {
            setStateInternal(2);
            updateDrawableForTargetState(state, true);
    ...
    void dispatchOnSlide(int top2) {
        View bottomSheet = this.viewRef.get();
        if (bottomSheet != null && !this.callbacks.isEmpty()) {
            float slideOffset = calculateSlideOffsetWithTop(top2);
            for (int i = 0; i < this.callbacks.size(); i++) {
    ...
    private void updateAccessibilityActions(View view, int viewIndex) {
        ...
        if (!this.fitToContents && this.state != 6) {
            this.expandHalfwayActionIds.put(viewIndex, addAccessibilityActionForState(view, C0605R.string.bottomsheet_action_expand_halfway, 6));
        }
