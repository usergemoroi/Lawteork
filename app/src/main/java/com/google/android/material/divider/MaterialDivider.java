...
public class MaterialDivider extends View {
    ...
    public MaterialDivider(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.materialDividerStyle);
    }
    ...
    */
    public MaterialDivider(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.MaterialDivider, defStyleAttr, i, new int[0]);
        this.thickness = attributes.getDimensionPixelSize(C0605R.styleable.MaterialDivider_dividerThickness, getResources().getDimensionPixelSize(C0605R.dimen.material_divider_thickness));
        ...
        setDividerColor(MaterialResources.getColorStateList(context2, attributes, C0605R.styleable.MaterialDivider_dividerColor).getDefaultColor());
        attributes.recycle();
    }
