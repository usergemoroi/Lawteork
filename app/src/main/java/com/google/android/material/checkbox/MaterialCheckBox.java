...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    private static final int[] INDETERMINATE_STATE_SET = {C0605R.attr.state_indeterminate};
    private static final int[] ERROR_STATE_SET = {C0605R.attr.state_error};
    private static final int[][] CHECKBOX_STATES = {new int[]{16842910, C0605R.attr.state_error}, new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.checkboxStyle);
    }
    ...
    */
    public MaterialCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.transitionToUnchecked = AnimatedVectorDrawableCompat.create(getContext(), C0605R.C0607drawable.mtrl_checkbox_button_checked_unchecked);
        ...
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0605R.styleable.MaterialCheckBox, defStyleAttr, i, new int[0]);
        this.buttonIconDrawable = attributes.getDrawable(C0605R.styleable.MaterialCheckBox_buttonIcon);
        if (this.buttonDrawable != null && ThemeEnforcement.isMaterial3Theme(context2) && isButtonDrawableLegacy(attributes)) {
            super.setButtonDrawable((Drawable) null);
            this.buttonDrawable = AppCompatResources.getDrawable(context2, C0605R.C0607drawable.mtrl_checkbox_button);
            this.usingMaterialButtonDrawable = true;
            if (this.buttonIconDrawable == null) {
                this.buttonIconDrawable = AppCompatResources.getDrawable(context2, C0605R.C0607drawable.mtrl_checkbox_button_icon);
            }
        }
        this.buttonIconTintList = MaterialResources.getColorStateList(context2, attributes, C0605R.styleable.MaterialCheckBox_buttonIconTint);
        this.buttonIconTintMode = ViewUtils.parseTintMode(attributes.getInt(C0605R.styleable.MaterialCheckBox_buttonIconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.useMaterialThemeColors = attributes.getBoolean(C0605R.styleable.MaterialCheckBox_useMaterialThemeColors, false);
        this.centerIfNoTextEnabled = attributes.getBoolean(C0605R.styleable.MaterialCheckBox_centerIfNoTextEnabled, true);
        this.errorShown = attributes.getBoolean(C0605R.styleable.MaterialCheckBox_errorShown, false);
        this.errorAccessibilityLabel = attributes.getText(C0605R.styleable.MaterialCheckBox_errorAccessibilityLabel);
        if (attributes.hasValue(C0605R.styleable.MaterialCheckBox_checkedState)) {
            setCheckedState(attributes.getInt(C0605R.styleable.MaterialCheckBox_checkedState, 0));
        }
        attributes.recycle();
    ...
    public /* synthetic */ void m137xdf87d0bf() {
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        ...
        if ((drawable instanceof AnimatedStateListDrawable) && this.transitionToUnchecked != null) {
            ((AnimatedStateListDrawable) drawable).addTransition(C0605R.C0608id.checked, C0605R.C0608id.unchecked, this.transitionToUnchecked, false);
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C0605R.C0608id.indeterminate, C0605R.C0608id.unchecked, this.transitionToUnchecked, false);
        }
    }
    ...
    private String getButtonStateDescription() {
        ...
        if (i == 1) {
            return getResources().getString(C0605R.string.mtrl_checkbox_state_description_checked);
        }
        if (i == 0) {
            return getResources().getString(C0605R.string.mtrl_checkbox_state_description_unchecked);
        }
        return getResources().getString(C0605R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray attributes) {
        int buttonResourceId = attributes.getResourceId(C0605R.styleable.MaterialCheckBox_android_button, 0);
        int buttonCompatResourceId = attributes.getResourceId(C0605R.styleable.MaterialCheckBox_buttonCompat, 0);
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int colorControlActivated = MaterialColors.getColor(this, C0605R.attr.colorControlActivated);
            int colorError = MaterialColors.getColor(this, C0605R.attr.colorError);
            int colorSurface = MaterialColors.getColor(this, C0605R.attr.colorSurface);
            int colorOnSurface = MaterialColors.getColor(this, C0605R.attr.colorOnSurface);
