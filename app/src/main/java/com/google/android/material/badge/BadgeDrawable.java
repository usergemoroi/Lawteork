...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0605R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0605R.attr.badgeStyle;
    ...
    private void tryWrapAnchorInCompatParent(final View anchorView) {
        ...
        if (anchorViewParent == null || anchorViewParent.getId() != C0605R.C0608id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            ...
            frameLayout.setId(C0605R.C0608id.mtrl_anchor_parent);
    ...
    private String getBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C0605R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
