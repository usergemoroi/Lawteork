...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.editTextStyle);
    }
    ...
    public TextInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0605R.styleable.TextInputEditText, defStyleAttr, C0605R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(attributes.getBoolean(C0605R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
        attributes.recycle();
    }
