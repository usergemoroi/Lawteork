...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0605R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0605R.attr.snackbarButtonStyle, C0605R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i = C0605R.layout.mtrl_layout_snackbar_include;
        } else {
            i = C0605R.layout.design_layout_snackbar_include;
        }
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    Snackbar.this.m239lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(listener, view);
                }
            });
        }
        return this;
    ...
    public /* synthetic */ void m239lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener listener, View view) {
