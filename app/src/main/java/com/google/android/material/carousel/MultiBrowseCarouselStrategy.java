...
public final class MultiBrowseCarouselStrategy extends CarouselStrategy {
    ...
    private float getExtraSmallSize(Context context) {
        return context.getResources().getDimension(C0605R.dimen.m3_carousel_gone_size);
    }

    private float getSmallSizeMin(Context context) {
        return context.getResources().getDimension(C0605R.dimen.m3_carousel_small_item_size_min);
    }

    private float getSmallSizeMax(Context context) {
        return context.getResources().getDimension(C0605R.dimen.m3_carousel_small_item_size_max);
    }
