...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C0605R.style.Widget_MaterialComponents_Toolbar;
    ...
    public MaterialToolbar(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.toolbarStyle);
    }
    ...
    */
    public MaterialToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.MaterialToolbar, defStyleAttr, i, new int[0]);
        if (a.hasValue(C0605R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(a.getColor(C0605R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = a.getBoolean(C0605R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = a.getBoolean(C0605R.styleable.MaterialToolbar_subtitleCentered, false);
        int index = a.getInt(C0605R.styleable.MaterialToolbar_logoScaleType, -1);
        if (index >= 0) {
        ...
        if (a.hasValue(C0605R.styleable.MaterialToolbar_logoAdjustViewBounds)) {
            this.logoAdjustViewBounds = Boolean.valueOf(a.getBoolean(C0605R.styleable.MaterialToolbar_logoAdjustViewBounds, false));
        }
        a.recycle();
