...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    private static final int DEF_STYLE_RES = C0605R.style.Widget_MaterialComponents_ShapeableImageView;
    ...
    */
    public ShapeableImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context2.obtainStyledAttributes(attrs, C0605R.styleable.ShapeableImageView, defStyle, i);
        setLayerType(2, null);
        this.strokeColor = MaterialResources.getColorStateList(context2, attributes, C0605R.styleable.ShapeableImageView_strokeColor);
        this.strokeWidth = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_strokeWidth, 0);
        int contentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPadding, 0);
        ...
        this.leftContentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPaddingLeft, contentPadding);
        this.topContentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPaddingTop, contentPadding);
        this.rightContentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPaddingRight, contentPadding);
        this.bottomContentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPaddingBottom, contentPadding);
        this.startContentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPaddingStart, Integer.MIN_VALUE);
        this.endContentPadding = attributes.getDimensionPixelSize(C0605R.styleable.ShapeableImageView_contentPaddingEnd, Integer.MIN_VALUE);
        attributes.recycle();
    ...
    public void setContentPadding(int left, int top2, int right, int bottom) {
        this.startContentPadding = Integer.MIN_VALUE;
        this.endContentPadding = Integer.MIN_VALUE;
        super.setPadding((super.getPaddingLeft() - this.leftContentPadding) + left, (super.getPaddingTop() - this.topContentPadding) + top2, (super.getPaddingRight() - this.rightContentPadding) + right, (super.getPaddingBottom() - this.bottomContentPadding) + bottom);
        this.leftContentPadding = left;
        this.topContentPadding = top2;
        this.rightContentPadding = right;
        this.bottomContentPadding = bottom;
    }

    public void setContentPaddingRelative(int start, int top2, int end, int bottom) {
        super.setPaddingRelative((super.getPaddingStart() - getContentPaddingStart()) + start, (super.getPaddingTop() - this.topContentPadding) + top2, (super.getPaddingEnd() - getContentPaddingEnd()) + end, (super.getPaddingBottom() - this.bottomContentPadding) + bottom);
    ...
    public void setPadding(int left, int top2, int right, int bottom) {
        super.setPadding(getContentPaddingLeft() + left, getContentPaddingTop() + top2, getContentPaddingRight() + right, getContentPaddingBottom() + bottom);
    }

    @Override // android.view.View
    public void setPaddingRelative(int start, int top2, int end, int bottom) {
        super.setPaddingRelative(getContentPaddingStart() + start, getContentPaddingTop() + top2, getContentPaddingEnd() + end, getContentPaddingBottom() + bottom);
    }
