...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int colorToHarmonize) {
        return harmonize(colorToHarmonize, getColor(context, C0605R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static ColorRoles getColorRoles(Context context, int color) {
        return getColorRoles(color, MaterialAttributes.resolveBoolean(context, C0605R.attr.isLightTheme, true));
    }
