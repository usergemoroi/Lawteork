...
public class Scheme {
    ...
    public static Scheme light(int argb) {
        return lightFromCorePalette(CorePalette.m136of(argb));
    }

    public static Scheme dark(int argb) {
        return darkFromCorePalette(CorePalette.m136of(argb));
    }
    ...
    private static Scheme lightFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f126a1.tone(40)).withOnPrimary(core.f126a1.tone(100)).withPrimaryContainer(core.f126a1.tone(90)).withOnPrimaryContainer(core.f126a1.tone(10)).withSecondary(core.f127a2.tone(40)).withOnSecondary(core.f127a2.tone(100)).withSecondaryContainer(core.f127a2.tone(90)).withOnSecondaryContainer(core.f127a2.tone(10)).withTertiary(core.f128a3.tone(40)).withOnTertiary(core.f128a3.tone(100)).withTertiaryContainer(core.f128a3.tone(90)).withOnTertiaryContainer(core.f128a3.tone(10)).withError(core.error.tone(40)).withOnError(core.error.tone(100)).withErrorContainer(core.error.tone(90)).withOnErrorContainer(core.error.tone(10)).withBackground(core.f129n1.tone(99)).withOnBackground(core.f129n1.tone(10)).withSurface(core.f129n1.tone(99)).withOnSurface(core.f129n1.tone(10)).withSurfaceVariant(core.f130n2.tone(90)).withOnSurfaceVariant(core.f130n2.tone(30)).withOutline(core.f130n2.tone(50)).withOutlineVariant(core.f130n2.tone(80)).withShadow(core.f129n1.tone(0)).withScrim(core.f129n1.tone(0)).withInverseSurface(core.f129n1.tone(20)).withInverseOnSurface(core.f129n1.tone(95)).withInversePrimary(core.f126a1.tone(80));
    }

    private static Scheme darkFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f126a1.tone(80)).withOnPrimary(core.f126a1.tone(20)).withPrimaryContainer(core.f126a1.tone(30)).withOnPrimaryContainer(core.f126a1.tone(90)).withSecondary(core.f127a2.tone(80)).withOnSecondary(core.f127a2.tone(20)).withSecondaryContainer(core.f127a2.tone(30)).withOnSecondaryContainer(core.f127a2.tone(90)).withTertiary(core.f128a3.tone(80)).withOnTertiary(core.f128a3.tone(20)).withTertiaryContainer(core.f128a3.tone(30)).withOnTertiaryContainer(core.f128a3.tone(90)).withError(core.error.tone(80)).withOnError(core.error.tone(20)).withErrorContainer(core.error.tone(30)).withOnErrorContainer(core.error.tone(80)).withBackground(core.f129n1.tone(10)).withOnBackground(core.f129n1.tone(90)).withSurface(core.f129n1.tone(10)).withOnSurface(core.f129n1.tone(90)).withSurfaceVariant(core.f130n2.tone(30)).withOnSurfaceVariant(core.f130n2.tone(80)).withOutline(core.f130n2.tone(60)).withOutlineVariant(core.f130n2.tone(30)).withShadow(core.f129n1.tone(0)).withScrim(core.f129n1.tone(0)).withInverseSurface(core.f129n1.tone(90)).withInverseOnSurface(core.f129n1.tone(20)).withInversePrimary(core.f126a1.tone(40));
    }
