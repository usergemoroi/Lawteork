...
public class ClippableRoundedCornerLayout extends FrameLayout {
    ...
    public void updateClipBoundsAndCornerRadius(float left, float top2, float right, float bottom, float cornerRadius) {
        updateClipBoundsAndCornerRadius(new RectF(left, top2, right, bottom), cornerRadius);
    }
