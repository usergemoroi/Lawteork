...
public final class CollapsingTextHelper {
    ...
    public void setExpandedBounds(int left, int top2, int right, int bottom) {
        if (!rectEquals(this.expandedBounds, left, top2, right, bottom)) {
            this.expandedBounds.set(left, top2, right, bottom);
    ...
    public void setCollapsedBounds(int left, int top2, int right, int bottom) {
        if (!rectEquals(this.collapsedBounds, left, top2, right, bottom)) {
            this.collapsedBounds.set(left, top2, right, bottom);
            this.boundsChanged = true;
        }
    }
    ...
    private static boolean rectEquals(Rect r, int left, int top2, int right, int bottom) {
        return r.left == left && r.top == top2 && r.right == right && r.bottom == bottom;
    }
}
