...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_Design_CollapsingToolbar;
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.collapsingToolbarLayoutStyle);
    }
    ...
    */
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.CollapsingToolbarLayout, defStyleAttr, i, new int[0]);
        collapsingTextHelper.setExpandedTextGravity(a.getInt(C0605R.styleable.CollapsingToolbarLayout_expandedTitleGravity, 8388691));
        collapsingTextHelper.setCollapsedTextGravity(a.getInt(C0605R.styleable.CollapsingToolbarLayout_collapsedTitleGravity, 8388627));
        int dimensionPixelSize = a.getDimensionPixelSize(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMargin, 0);
        this.expandedMarginBottom = dimensionPixelSize;
        this.expandedMarginEnd = dimensionPixelSize;
        this.expandedMarginTop = dimensionPixelSize;
        this.expandedMarginStart = dimensionPixelSize;
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart)) {
            this.expandedMarginStart = a.getDimensionPixelSize(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart, 0);
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd)) {
            this.expandedMarginEnd = a.getDimensionPixelSize(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd, 0);
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop)) {
            this.expandedMarginTop = a.getDimensionPixelSize(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop, 0);
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom)) {
            this.expandedMarginBottom = a.getDimensionPixelSize(C0605R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom, 0);
        }
        this.collapsingTitleEnabled = a.getBoolean(C0605R.styleable.CollapsingToolbarLayout_titleEnabled, true);
        setTitle(a.getText(C0605R.styleable.CollapsingToolbarLayout_title));
        collapsingTextHelper.setExpandedTextAppearance(C0605R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
        collapsingTextHelper.setCollapsedTextAppearance(C0030R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance)) {
            collapsingTextHelper.setExpandedTextAppearance(a.getResourceId(C0605R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance, 0));
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance)) {
            collapsingTextHelper.setCollapsedTextAppearance(a.getResourceId(C0605R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance, 0));
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_titleTextEllipsize)) {
            setTitleEllipsize(convertEllipsizeToTruncateAt(a.getInt(C0605R.styleable.CollapsingToolbarLayout_titleTextEllipsize, -1)));
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_expandedTitleTextColor)) {
            collapsingTextHelper.setExpandedTextColor(MaterialResources.getColorStateList(context2, a, C0605R.styleable.CollapsingToolbarLayout_expandedTitleTextColor));
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_collapsedTitleTextColor)) {
            collapsingTextHelper.setCollapsedTextColor(MaterialResources.getColorStateList(context2, a, C0605R.styleable.CollapsingToolbarLayout_collapsedTitleTextColor));
        }
        this.scrimVisibleHeightTrigger = a.getDimensionPixelSize(C0605R.styleable.CollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_maxLines)) {
            collapsingTextHelper.setMaxLines(a.getInt(C0605R.styleable.CollapsingToolbarLayout_maxLines, 1));
        }
        if (a.hasValue(C0605R.styleable.CollapsingToolbarLayout_titlePositionInterpolator)) {
            collapsingTextHelper.setPositionInterpolator(android.view.animation.AnimationUtils.loadInterpolator(context2, a.getResourceId(C0605R.styleable.CollapsingToolbarLayout_titlePositionInterpolator, 0)));
        }
        this.scrimAnimationDuration = a.getInt(C0605R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, DEFAULT_SCRIM_ANIMATION_DURATION);
        this.scrimAnimationFadeInInterpolator = MotionUtils.resolveThemeInterpolator(context2, C0605R.attr.motionEasingStandardInterpolator, AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR);
        this.scrimAnimationFadeOutInterpolator = MotionUtils.resolveThemeInterpolator(context2, C0605R.attr.motionEasingStandardInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        setContentScrim(a.getDrawable(C0605R.styleable.CollapsingToolbarLayout_contentScrim));
        setStatusBarScrim(a.getDrawable(C0605R.styleable.CollapsingToolbarLayout_statusBarScrim));
        setTitleCollapseMode(a.getInt(C0605R.styleable.CollapsingToolbarLayout_titleCollapseMode, 0));
        this.toolbarId = a.getResourceId(C0605R.styleable.CollapsingToolbarLayout_toolbarId, -1);
        this.forceApplySystemWindowInsetTop = a.getBoolean(C0605R.styleable.CollapsingToolbarLayout_forceApplySystemWindowInsetTop, false);
        this.extraMultilineHeightEnabled = a.getBoolean(C0605R.styleable.CollapsingToolbarLayout_extraMultilineHeightEnabled, false);
        a.recycle();
    ...
    protected void onLayout(boolean changed, int left, int top2, int right, int bottom) {
        ...
        updateTextBounds(left, top2, right, bottom, false);
        updateTitleFromToolbarIfNeeded();
    ...
    private void updateTextBounds(int left, int top2, int right, int bottom, boolean forceRecalculate) {
        View view;
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            ...
            if (z || forceRecalculate) {
                ...
                this.collapsingTextHelper.setExpandedBounds(isRtl ? this.expandedMarginEnd : this.expandedMarginStart, this.tmpRect.top + this.expandedMarginTop, (right - left) - (isRtl ? this.expandedMarginStart : this.expandedMarginEnd), (bottom - top2) - this.expandedMarginBottom);
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper offsetHelper = (ViewOffsetHelper) view.getTag(C0605R.C0608id.view_offset_helper);
        if (offsetHelper == null) {
            ViewOffsetHelper offsetHelper2 = new ViewOffsetHelper(view);
            view.setTag(C0605R.C0608id.view_offset_helper, offsetHelper2);
    ...
    public void setTitleCollapseMode(int titleCollapseMode) {
        ...
        if (fadeModeEnabled && this.contentScrim == null) {
            float appBarElevation = getResources().getDimension(C0605R.dimen.design_appbar_elevation);
    ...
    public void setExpandedTitleMargin(int start, int top2, int end, int bottom) {
        this.expandedMarginStart = start;
        this.expandedMarginTop = top2;
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, C0605R.styleable.CollapsingToolbarLayout_Layout);
            this.collapseMode = a.getInt(C0605R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
            setParallaxMultiplier(a.getFloat(C0605R.styleable.CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier, 0.5f));
            a.recycle();
        }
