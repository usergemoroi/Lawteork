...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float elevation) {
        int colorSurface = MaterialColors.getColor(context, C0605R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
    ...
    public void setPadding(int left, int top2, int right, int bottom) {
        ...
        this.drawableState.padding.set(left, top2, right, bottom);
        invalidateSelf();
    }
