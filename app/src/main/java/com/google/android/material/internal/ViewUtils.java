...
public class ViewUtils {
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(int start, int top2, int end, int bottom) {
            this.start = start;
            this.f258top = top2;
            this.end = end;
            this.bottom = bottom;
        ...
        public RelativePadding(RelativePadding other) {
            ...
            this.f258top = other.f258top;
            this.end = other.end;
            this.bottom = other.bottom;
        }

        public void applyToView(View view) {
            ViewCompat.setPaddingRelative(view, this.start, this.f258top, this.end, this.bottom);
        }
    }
    ...
    public static void doOnApplyWindowInsets(View view, AttributeSet attrs, int defStyleAttr, int defStyleRes, final OnApplyWindowInsetsListener listener) {
        TypedArray a = view.getContext().obtainStyledAttributes(attrs, C0605R.styleable.Insets, defStyleAttr, defStyleRes);
        final boolean paddingBottomSystemWindowInsets = a.getBoolean(C0605R.styleable.Insets_paddingBottomSystemWindowInsets, false);
        final boolean paddingLeftSystemWindowInsets = a.getBoolean(C0605R.styleable.Insets_paddingLeftSystemWindowInsets, false);
        final boolean paddingRightSystemWindowInsets = a.getBoolean(C0605R.styleable.Insets_paddingRightSystemWindowInsets, false);
        a.recycle();
