...
class UtcDates {
    ...
    public static String getDefaultTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        String yearChar = res.getString(C0605R.string.mtrl_picker_text_input_year_abbr);
        String monthChar = res.getString(C0605R.string.mtrl_picker_text_input_month_abbr);
        String dayChar = res.getString(C0605R.string.mtrl_picker_text_input_day_abbr);
    ...
    private static String removeYearFromDateFormatPattern(String pattern) {
        ...
        return pattern.replace(yearPattern, ILogger.MSG_SEPARATOR).trim();
    }
