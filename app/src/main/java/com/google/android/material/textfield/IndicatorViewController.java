...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputView) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C0605R.dimen.design_textinput_caption_translate_y);
        this.captionTranslationYAnimationDuration = MotionUtils.resolveThemeDuration(context, C0605R.attr.motionDurationShort4, DEFAULT_CAPTION_TRANSLATION_Y_ANIMATION_DURATION);
        this.captionFadeInAnimationDuration = MotionUtils.resolveThemeDuration(context, C0605R.attr.motionDurationMedium4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context, C0605R.attr.motionDurationShort4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        this.captionTranslationYAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, C0605R.attr.motionEasingEmphasizedDecelerateInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, C0605R.attr.motionEasingEmphasizedDecelerateInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.captionFadeOutAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, C0605R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    }
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            ...
            ViewCompat.setPaddingRelative(this.indicatorArea, getIndicatorPadding(isFontScaleLarge, C0605R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.getPaddingStart(editText)), getIndicatorPadding(isFontScaleLarge, C0605R.dimen.material_helper_text_font_1_3_padding_top, this.context.getResources().getDimensionPixelSize(C0605R.dimen.material_helper_text_default_padding_top)), getIndicatorPadding(isFontScaleLarge, C0605R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.getPaddingEnd(editText)), 0);
        }
    }
    ...
    public void setErrorEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            appCompatTextView.setId(C0605R.C0608id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            appCompatTextView.setId(C0605R.C0608id.textinput_helper_text);
