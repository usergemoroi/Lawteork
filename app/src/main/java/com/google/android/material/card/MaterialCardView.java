...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int[] DRAGGED_STATE_SET = {C0605R.attr.state_dragged};
    private static final int DEF_STYLE_RES = C0605R.style.Widget_MaterialComponents_CardView;
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.materialCardViewStyle);
    }
    ...
    */
    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.MaterialCardView, defStyleAttr, i, new int[0]);
    ...
    public void setContentPadding(int left, int top2, int right, int bottom) {
        this.cardViewHelper.setUserContentPadding(left, top2, right, bottom);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setAncestorContentPadding(int left, int top2, int right, int bottom) {
        super.setContentPadding(left, top2, right, bottom);
    }
