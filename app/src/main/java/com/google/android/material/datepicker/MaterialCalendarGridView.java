...
public final class MaterialCalendarGridView extends GridView {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (MaterialDatePicker.isFullscreen(getContext())) {
            setNextFocusLeftId(C0605R.C0608id.cancel_button);
            setNextFocusRightId(C0605R.C0608id.confirm_button);
        }
            ...
            if (range.first == null) {
                ...
                if (!skipMonth(firstOfMonth, lastOfMonth, Long.valueOf(startItem), Long.valueOf(endItem))) {
                    ...
                    while (row <= lastRow) {
                        ...
                        int top2 = firstView.getTop() + calendarStyle.day.getTopInset();
                        ...
                        canvas.drawRect(firstPositionInRow2, top2, lastHighlightPosition2, bottom, calendarStyle.rangeFill);
                        row++;
                        materialCalendarGridView = this;
