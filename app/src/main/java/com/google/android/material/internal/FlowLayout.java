...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attrs) {
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, C0605R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = array.getDimensionPixelSize(C0605R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = array.getDimensionPixelSize(C0605R.styleable.FlowLayout_itemSpacing, 0);
        array.recycle();
    }
    ...
    protected void onLayout(boolean sizeChanged, int left, int top2, int right, int bottom) {
        int paddingStart;
        if (getChildCount() != 0) {
            this.rowCount = 1;
            ...
            while (i < getChildCount()) {
                View child = getChildAt(i);
                if (child.getVisibility() == 8) {
                    child.setTag(C0605R.C0608id.row_index_key, -1);
                    ...
                    paddingStart = paddingStart2;
                    child.setTag(C0605R.C0608id.row_index_key, Integer.valueOf(this.rowCount - 1));
    ...
    public int getRowIndex(View child) {
        Object index = child.getTag(C0605R.C0608id.row_index_key);
