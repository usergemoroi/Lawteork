...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.chipStyle);
    }
    ...
    */
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.Chip, defStyleAttr, i, new int[0]);
        boolean hasShapeAppearanceAttribute = a.hasValue(C0605R.styleable.Chip_shapeAppearance);
        a.recycle();
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                Chip.this.m236lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z);
            }
        });
    }
    ...
    public /* synthetic */ void m236lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton buttonView, boolean isChecked) {
    ...
    private void initMinTouchTarget(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0605R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = a.getBoolean(C0605R.styleable.Chip_ensureMinTouchTargetSize, false);
        float defaultMinTouchTargetSize = (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48));
        this.minTouchTargetSize = (int) Math.ceil(a.getDimension(C0605R.styleable.Chip_chipMinTouchTargetSize, defaultMinTouchTargetSize));
        a.recycle();
    }
        ...
        protected void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            if (virtualViewId == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = C0605R.string.mtrl_chip_close_icon_content_description;
