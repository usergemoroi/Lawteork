...
public class FloatingActionButtonImpl {
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C0605R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C0605R.attr.motionEasingEmphasizedInterpolator;
    private static final int HIDE_ANIM_DURATION_ATTR = C0605R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C0605R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    private AnimatorSet createDefaultAnimator(final float targetOpacity, final float targetScale, final float targetIconScale, int duration, int interpolator) {
        ...
        AnimatorSetCompat.playTogether(set, animators);
        set.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), duration, this.view.getContext().getResources().getInteger(C0605R.integer.material_motion_duration_long_1)));
