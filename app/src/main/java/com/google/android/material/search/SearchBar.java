...
public class SearchBar extends Toolbar {
    ...
    private static final int DEF_STYLE_RES = C0605R.style.Widget_Material3_SearchBar;
    ...
    public /* synthetic */ void m238lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean enabled) {
    ...
    public SearchBar(Context context, AttributeSet attrs) {
        this(context, attrs, C0605R.attr.materialSearchBarStyle);
    }
    ...
    */
    public SearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda0
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                SearchBar.this.m238lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        Context context2 = getContext();
        validateAttributes(attrs);
        this.defaultNavigationIcon = AppCompatResources.getDrawable(context2, C0605R.C0607drawable.ic_search_black_24);
        this.searchBarAnimationHelper = new SearchBarAnimationHelper();
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0605R.styleable.SearchBar, defStyleAttr, i, new int[0]);
        ShapeAppearanceModel shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, i).build();
        float elevation = a.getDimension(C0605R.styleable.SearchBar_elevation, 0.0f);
        this.defaultMarginsEnabled = a.getBoolean(C0605R.styleable.SearchBar_defaultMarginsEnabled, true);
        this.defaultScrollFlagsEnabled = a.getBoolean(C0605R.styleable.SearchBar_defaultScrollFlagsEnabled, true);
        boolean hideNavigationIcon = a.getBoolean(C0605R.styleable.SearchBar_hideNavigationIcon, false);
        this.forceDefaultNavigationOnClickListener = a.getBoolean(C0605R.styleable.SearchBar_forceDefaultNavigationOnClickListener, false);
        this.tintNavigationIcon = a.getBoolean(C0605R.styleable.SearchBar_tintNavigationIcon, true);
        if (a.hasValue(C0605R.styleable.SearchBar_navigationIconTint)) {
            this.navigationIconTint = Integer.valueOf(a.getColor(C0605R.styleable.SearchBar_navigationIconTint, -1));
        }
        int textAppearanceResId = a.getResourceId(C0605R.styleable.SearchBar_android_textAppearance, -1);
        String text = a.getString(C0605R.styleable.SearchBar_android_text);
        String hint = a.getString(C0605R.styleable.SearchBar_android_hint);
        float strokeWidth = a.getDimension(C0605R.styleable.SearchBar_strokeWidth, -1.0f);
        int strokeColor = a.getColor(C0605R.styleable.SearchBar_strokeColor, 0);
        a.recycle();
        ...
        setClickable(true);
        setFocusable(true);
        LayoutInflater.from(context2).inflate(C0605R.layout.mtrl_search_bar, this);
        this.layoutInflated = true;
        this.textView = (TextView) findViewById(C0605R.C0608id.search_bar_text_view);
    ...
    private void initTextView(int textAppearanceResId, String text, String hint) {
        ...
        if (getNavigationIcon() == null) {
            MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(C0605R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearance, float elevation, float strokeWidth, int strokeColor) {
        ...
        int backgroundColor = MaterialColors.getColor(this, C0605R.attr.colorSurface);
        int rippleColor = MaterialColors.getColor(this, C0605R.attr.colorControlHighlight);
    ...
    private Drawable maybeTintNavigationIcon(Drawable navigationIcon) {
        ...
        if (num != null) {
            ...
            if (navigationIcon == this.defaultNavigationIcon) {
                navigationIconColorAttr = C0605R.attr.colorOnSurfaceVariant;
            } else {
                navigationIconColorAttr = C0605R.attr.colorOnSurface;
            }
    ...
    private void setDefaultMargins() {
        if (this.defaultMarginsEnabled && (getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int marginHorizontal = resources.getDimensionPixelSize(C0605R.dimen.m3_searchbar_margin_horizontal);
            int marginVertical = resources.getDimensionPixelSize(C0605R.dimen.m3_searchbar_margin_vertical);
    ...
    private void layoutCenterView() {
        ...
        int top2 = (getMeasuredHeight() / 2) - (centerViewHeight / 2);
        int bottom = top2 + centerViewHeight;
        layoutChild(this.centerView, left, top2, right, bottom);
    }

    private void layoutChild(View child, int left, int top2, int right, int bottom) {
        if (ViewCompat.getLayoutDirection(this) == 1) {
            child.layout(getMeasuredWidth() - right, top2, getMeasuredWidth() - left, bottom);
        } else {
    ...
    public /* synthetic */ void m130x58362b63() {
