...
public class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView card, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray cardViewAttributes = card.getContext().obtainStyledAttributes(attrs, C0605R.styleable.CardView, defStyleAttr, C0605R.style.CardView);
        if (cardViewAttributes.hasValue(C0605R.styleable.CardView_cardCornerRadius)) {
            shapeAppearanceModelBuilder.setAllCornerSizes(cardViewAttributes.getDimension(C0605R.styleable.CardView_cardCornerRadius, 0.0f));
        }
        this.foregroundContentDrawable = new MaterialShapeDrawable();
        setShapeAppearanceModel(shapeAppearanceModelBuilder.build());
        this.iconFadeAnimInterpolator = MotionUtils.resolveThemeInterpolator(card.getContext(), C0605R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.iconFadeInAnimDuration = MotionUtils.resolveThemeDuration(card.getContext(), C0605R.attr.motionDurationShort2, DEFAULT_FADE_ANIM_DURATION);
        this.iconFadeOutAnimDuration = MotionUtils.resolveThemeDuration(card.getContext(), C0605R.attr.motionDurationShort1, DEFAULT_FADE_ANIM_DURATION);
        cardViewAttributes.recycle();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void loadFromAttributes(TypedArray attributes) {
        ColorStateList colorStateList = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0605R.styleable.MaterialCardView_strokeColor);
        this.strokeColor = colorStateList;
        if (colorStateList == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = attributes.getDimensionPixelSize(C0605R.styleable.MaterialCardView_strokeWidth, 0);
        boolean z = attributes.getBoolean(C0605R.styleable.MaterialCardView_android_checkable, false);
        this.checkable = z;
        this.materialCardView.setLongClickable(z);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0605R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), attributes, C0605R.styleable.MaterialCardView_checkedIcon));
        setCheckedIconSize(attributes.getDimensionPixelSize(C0605R.styleable.MaterialCardView_checkedIconSize, 0));
        setCheckedIconMargin(attributes.getDimensionPixelSize(C0605R.styleable.MaterialCardView_checkedIconMargin, 0));
        this.checkedIconGravity = attributes.getInteger(C0605R.styleable.MaterialCardView_checkedIconGravity, 8388661);
        ColorStateList colorStateList2 = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0605R.styleable.MaterialCardView_rippleColor);
        this.rippleColor = colorStateList2;
        if (colorStateList2 == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C0605R.attr.colorControlHighlight));
        }
        ColorStateList foregroundColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0605R.styleable.MaterialCardView_cardForegroundColor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setUserContentPadding(int left, int top2, int right, int bottom) {
        this.userContentPadding.set(left, top2, right, bottom);
    ...
    public void animateCheckedIcon(boolean checked) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.MaterialCardViewHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                MaterialCardViewHelper.this.m139xa4d79c2b(valueAnimator2);
            }
        });
    ...
    public /* synthetic */ void m139xa4d79c2b(ValueAnimator animation) {
    ...
    public void setCheckedIcon(Drawable checkedIcon) {
        ...
        if (layerDrawable != null) {
            layerDrawable.setDrawableByLayerId(C0605R.C0608id.mtrl_card_checked_layer_id, this.checkedIcon);
        }
    }
    ...
    public void recalculateCheckedIconPosition(int measuredWidth, int measuredHeight) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if (isCheckedIconBottom()) {
                top2 = ((measuredHeight - this.checkedIconMargin) - this.checkedIconSize) - verticalPaddingAdjustment;
            } else {
                top2 = this.checkedIconMargin;
            }
            ...
            this.clickableForegroundDrawable.setLayerInset(2, left, top2, right, bottom);
        }
    }
    ...
    private Drawable getClickableForeground() {
        ...
        if (this.clickableForegroundDrawable == null) {
            ...
            layerDrawable.setId(2, C0605R.C0608id.mtrl_card_checked_layer_id);
        }
