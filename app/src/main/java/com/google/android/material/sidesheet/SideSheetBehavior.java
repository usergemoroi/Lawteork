...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    private static final int DEFAULT_ACCESSIBILITY_PANE_TITLE = C0605R.string.side_sheet_accessibility_pane_title;
    private static final int DEF_STYLE_RES = C0605R.style.Widget_Material3_SideSheet;
    ...
    public SideSheetBehavior(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0605R.styleable.SideSheetBehavior_Layout);
        if (a.hasValue(C0605R.styleable.SideSheetBehavior_Layout_backgroundTint)) {
            this.backgroundTint = MaterialResources.getColorStateList(context, a, C0605R.styleable.SideSheetBehavior_Layout_backgroundTint);
        }
        if (a.hasValue(C0605R.styleable.SideSheetBehavior_Layout_shapeAppearance)) {
            this.shapeAppearanceModel = ShapeAppearanceModel.builder(context, attrs, 0, DEF_STYLE_RES).build();
        }
        if (a.hasValue(C0605R.styleable.SideSheetBehavior_Layout_coplanarSiblingViewId)) {
            setCoplanarSiblingViewId(a.getResourceId(C0605R.styleable.SideSheetBehavior_Layout_coplanarSiblingViewId, -1));
        }
        createMaterialShapeDrawableIfNeeded(context);
        this.elevation = a.getDimension(C0605R.styleable.SideSheetBehavior_Layout_android_elevation, -1.0f);
        setDraggable(a.getBoolean(C0605R.styleable.SideSheetBehavior_Layout_behavior_draggable, true));
        a.recycle();
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(this.viewRef.get(), new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    SideSheetBehavior.this.m115xc0f1d0a9(state);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m115xc0f1d0a9(int finalState) {
    ...
    public class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SideSheetBehavior.StateSettlingTracker.this.m114xe5f914a3();
            }
        };
        ...
        public /* synthetic */ void m114xe5f914a3() {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(final int state) {
        return new AccessibilityViewCommand() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda1
            ...
            public final boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return SideSheetBehavior.this.m116x30b69a97(state, view, commandArguments);
            }
        };
    }
    ...
    public /* synthetic */ boolean m116x30b69a97(int state, View view, AccessibilityViewCommand.CommandArguments arguments) {
        setState(state);
        return true;
    }
}
