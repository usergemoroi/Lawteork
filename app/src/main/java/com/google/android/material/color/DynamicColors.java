...
public class DynamicColors {
    ...
    private static final int[] DYNAMIC_COLOR_THEME_OVERLAY_ATTRIBUTE = {C0605R.attr.dynamicColorThemeOverlay};
    ...
    public static void applyToActivityIfAvailable(Activity activity, DynamicColorsOptions dynamicColorsOptions) {
        ...
        if (dynamicColorsOptions.getPrecondition().shouldApplyDynamicColors(activity, theme)) {
            if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                SchemeContent scheme = new SchemeContent(Hct.fromInt(dynamicColorsOptions.getContentBasedSeedColor().intValue()), !MaterialAttributes.resolveBoolean(activity, C0605R.attr.isLightTheme, true), 0.0d);
