...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box cube) {
        ...
        double xx = ((((((this.moments[getIndex(cube.f138r1, cube.f136g1, cube.f134b1)] - this.moments[getIndex(cube.f138r1, cube.f136g1, cube.f133b0)]) - this.moments[getIndex(cube.f138r1, cube.f135g0, cube.f134b1)]) + this.moments[getIndex(cube.f138r1, cube.f135g0, cube.f133b0)]) - this.moments[getIndex(cube.f137r0, cube.f136g1, cube.f134b1)]) + this.moments[getIndex(cube.f137r0, cube.f136g1, cube.f133b0)]) + this.moments[getIndex(cube.f137r0, cube.f135g0, cube.f134b1)]) - this.moments[getIndex(cube.f137r0, cube.f135g0, cube.f133b0)];
    ...
    Boolean cut(Box one, Box two) {
        ...
        MaximizeResult maxRResult = maximize(one, Direction.RED, one.f137r0 + 1, one.f138r1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxGResult = maximize(one, Direction.GREEN, one.f135g0 + 1, one.f136g1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxBResult = maximize(one, Direction.BLUE, one.f133b0 + 1, one.f134b1, wholeR, wholeG, wholeB, wholeW);
        ...
        two.f138r1 = one.f138r1;
        two.f136g1 = one.f136g1;
        two.f134b1 = one.f134b1;
        switch (C06801.f132x8739cebf[cutDirection.ordinal()]) {
            case 1:
                one.f138r1 = maxRResult.cutLocation;
                two.f137r0 = one.f138r1;
                two.f135g0 = one.f135g0;
                two.f133b0 = one.f133b0;
                break;
            case 2:
                one.f136g1 = maxGResult.cutLocation;
                two.f137r0 = one.f137r0;
                two.f135g0 = one.f136g1;
                two.f133b0 = one.f133b0;
                break;
            case 3:
                one.f134b1 = maxBResult.cutLocation;
                two.f137r0 = one.f137r0;
                two.f135g0 = one.f135g0;
                two.f133b0 = one.f134b1;
                break;
        }
        one.vol = (one.f138r1 - one.f137r0) * (one.f136g1 - one.f135g0) * (one.f134b1 - one.f133b0);
        two.vol = (two.f138r1 - two.f137r0) * (two.f136g1 - two.f135g0) * (two.f134b1 - two.f133b0);
        return true;
    }
    ...
    public static /* synthetic */ class C06801 {
        ...
        static final /* synthetic */ int[] f132x8739cebf;
        ...
        static {
            ...
            try {
                f132x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f132x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box cube, int[] moment) {
        return ((((((moment[getIndex(cube.f138r1, cube.f136g1, cube.f134b1)] - moment[getIndex(cube.f138r1, cube.f136g1, cube.f133b0)]) - moment[getIndex(cube.f138r1, cube.f135g0, cube.f134b1)]) + moment[getIndex(cube.f138r1, cube.f135g0, cube.f133b0)]) - moment[getIndex(cube.f137r0, cube.f136g1, cube.f134b1)]) + moment[getIndex(cube.f137r0, cube.f136g1, cube.f133b0)]) + moment[getIndex(cube.f137r0, cube.f135g0, cube.f134b1)]) - moment[getIndex(cube.f137r0, cube.f135g0, cube.f133b0)];
    }

    static int bottom(Box cube, Direction direction, int[] moment) {
        switch (C06801.f132x8739cebf[direction.ordinal()]) {
            case 1:
                return (((-moment[getIndex(cube.f137r0, cube.f136g1, cube.f134b1)]) + moment[getIndex(cube.f137r0, cube.f136g1, cube.f133b0)]) + moment[getIndex(cube.f137r0, cube.f135g0, cube.f134b1)]) - moment[getIndex(cube.f137r0, cube.f135g0, cube.f133b0)];
            case 2:
                return (((-moment[getIndex(cube.f138r1, cube.f135g0, cube.f134b1)]) + moment[getIndex(cube.f138r1, cube.f135g0, cube.f133b0)]) + moment[getIndex(cube.f137r0, cube.f135g0, cube.f134b1)]) - moment[getIndex(cube.f137r0, cube.f135g0, cube.f133b0)];
            case 3:
                return (((-moment[getIndex(cube.f138r1, cube.f136g1, cube.f133b0)]) + moment[getIndex(cube.f138r1, cube.f135g0, cube.f133b0)]) + moment[getIndex(cube.f137r0, cube.f136g1, cube.f133b0)]) - moment[getIndex(cube.f137r0, cube.f135g0, cube.f133b0)];
            default:
    ...
    static int top(Box cube, Direction direction, int position, int[] moment) {
        switch (C06801.f132x8739cebf[direction.ordinal()]) {
            case 1:
                return ((moment[getIndex(position, cube.f136g1, cube.f134b1)] - moment[getIndex(position, cube.f136g1, cube.f133b0)]) - moment[getIndex(position, cube.f135g0, cube.f134b1)]) + moment[getIndex(position, cube.f135g0, cube.f133b0)];
            case 2:
                return ((moment[getIndex(cube.f138r1, position, cube.f134b1)] - moment[getIndex(cube.f138r1, position, cube.f133b0)]) - moment[getIndex(cube.f137r0, position, cube.f134b1)]) + moment[getIndex(cube.f137r0, position, cube.f133b0)];
            case 3:
                return ((moment[getIndex(cube.f138r1, cube.f136g1, position)] - moment[getIndex(cube.f138r1, cube.f135g0, position)]) - moment[getIndex(cube.f137r0, cube.f136g1, position)]) + moment[getIndex(cube.f137r0, cube.f135g0, position)];
            default:
                throw new IllegalArgumentException("unexpected direction " + direction);
        }
    }
