...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C0605R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C0605R.attr.materialCalendarStyle, C0605R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        int layout = this.fullscreen ? C0605R.layout.mtrl_picker_fullscreen : C0605R.layout.mtrl_picker_dialog;
        ...
        if (this.fullscreen) {
            View frame = root.findViewById(C0605R.C0608id.mtrl_calendar_frame);
            frame.setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View pane = root.findViewById(C0605R.C0608id.mtrl_calendar_main_pane);
            pane.setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) root.findViewById(C0605R.C0608id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) root.findViewById(C0605R.C0608id.mtrl_picker_header_toggle);
        this.headerTitleTextView = (TextView) root.findViewById(C0605R.C0608id.mtrl_picker_title_text);
        initHeaderToggle(context);
        this.confirmButton = (Button) root.findViewById(C0605R.C0608id.confirm_button);
        ...
        Button cancelButton = (Button) root.findViewById(C0605R.C0608id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int inset = getResources().getDimensionPixelOffset(C0605R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final View headerLayout = requireView().findViewById(C0605R.C0608id.fullscreen_header);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(headerLayout, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.4
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                int topInset = insets.getInsets(WindowInsetsCompat.Type.systemBars()).f255top;
    ...
    public void startPickerFragment() {
        ...
        fragmentTransaction.replace(C0605R.C0608id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton toggle) {
        ...
        if (this.headerToggleButton.isChecked()) {
            contentDescription = toggle.getContext().getString(C0605R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            contentDescription = toggle.getContext().getString(C0605R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        toggleDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0605R.C0607drawable.material_ic_calendar_black_24dp));
        toggleDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0605R.C0607drawable.material_ic_edit_black_24dp));
        return toggleDrawable;
    }

    private static CharSequence getFirstLineBySeparator(CharSequence charSequence) {
        if (charSequence != null) {
            String[] lines = TextUtils.split(String.valueOf(charSequence), ShellUtils.COMMAND_LINE_END);
    ...
    public static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C0605R.attr.nestedScrollable);
    }
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int padding = resources.getDimensionPixelOffset(C0605R.dimen.mtrl_calendar_content_padding);
        int daysInWeek = Month.current().daysInWeek;
        int dayWidth = resources.getDimensionPixelSize(C0605R.dimen.mtrl_calendar_day_width);
        int horizontalSpace = resources.getDimensionPixelOffset(C0605R.dimen.mtrl_calendar_month_horizontal_padding);
