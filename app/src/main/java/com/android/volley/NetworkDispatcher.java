    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                VolleyLog.m147e("Ignoring spurious interrupt of NetworkDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
    ...
    void processRequest(Request<?> request) {
        ...
        try {
            try {
                ...
                VolleyLog.m146e(e, "Unhandled exception %s", e.toString());
