...
public class VolleyLog {
    ...
    public static void setTag(String tag) {
        m148d("Changing log tag to %s", tag);
        TAG = tag;
        DEBUG = Log.isLoggable(tag, 2);
    }

    /* renamed from: v */
    public static void m145v(String format, Object... args) {
        if (DEBUG) {
    ...
    /* renamed from: d */
    public static void m148d(String format, Object... args) {
        Log.d(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m147e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m146e(Throwable tr, String format, Object... args) {
    ...
    public static class MarkerLog {
        ...
        public synchronized void finish(String header) {
            ...
            VolleyLog.m148d("(%-4d ms) %s", Long.valueOf(duration), header);
            for (Marker marker : this.mMarkers) {
                long thisTime = marker.time;
                VolleyLog.m148d("(+%-4d) [%2d] %s", Long.valueOf(thisTime - prevTime), Long.valueOf(marker.thread), marker.name);
                prevTime = thisTime;
            }
        }
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m147e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
        ...
        private long getTotalDuration() {
            ...
            long last = list.get(list.size() - 1).time;
            return last - first;
        }
    }
}
