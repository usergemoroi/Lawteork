...
public class Reflection {
    ...
    private static boolean unsealByDexFile(Context context) {
        byte[] bytes = Base64.decode(DEX, 2);
        ...
        try {
            ...
            Method exemptAll = bootstrapClass.getDeclaredMethod("exemptAll", new Class[0]);
            return ((Boolean) exemptAll.invoke(null, new Object[0])).booleanValue();
        } catch (Throwable e) {
            try {
                e.printStackTrace();
                if (code.exists()) {
