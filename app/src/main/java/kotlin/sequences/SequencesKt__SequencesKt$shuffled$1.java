...
@Metadata(m71d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m70d2 = {"<anonymous>", "", "T", "Lkotlin/sequences/SequenceScope;"}, m69k = 3, m68mv = {1, 7, 1}, m66xi = 48)
@DebugMetadata(m62c = "kotlin.sequences.SequencesKt__SequencesKt$shuffled$1", m61f = "Sequences.kt", m60i = {0, 0}, m59l = {145}, m58m = "invokeSuspend", m57n = {"$this$sequence", "buffer"}, m56s = {"L$0", "L$1"})
