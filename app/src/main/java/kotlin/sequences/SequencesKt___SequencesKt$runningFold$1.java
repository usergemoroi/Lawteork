...
@DebugMetadata(m62c = "kotlin.sequences.SequencesKt___SequencesKt$runningFold$1", m61f = "_Sequences.kt", m60i = {0, 1, 1}, m59l = {2286, 2290}, m58m = "invokeSuspend", m57n = {"$this$sequence", "$this$sequence", "accumulator"}, m56s = {"L$0", "L$0", "L$1"})
