...
@DebugMetadata(m62c = "kotlin.sequences.SequencesKt___SequencesKt$runningReduce$1", m61f = "_Sequences.kt", m60i = {0, 0, 0, 1, 1, 1}, m59l = {2344, 2347}, m58m = "invokeSuspend", m57n = {"$this$sequence", "iterator", "accumulator", "$this$sequence", "iterator", "accumulator"}, m56s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2"})
