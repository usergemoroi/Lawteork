...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0175R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0175R.dimen.compat_notification_large_icon_max_height);
        ...
        */
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                contentView.setViewVisibility(C0175R.C0178id.icon, 0);
                contentView.setImageViewBitmap(C0175R.C0178id.icon, this.mBuilder.mLargeIcon);
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0175R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0175R.dimen.notification_small_icon_background_padding) * 2);
                    Bitmap smallBit = createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor());
                    contentView.setImageViewBitmap(C0175R.C0178id.right_icon, smallBit);
                    contentView.setViewVisibility(C0175R.C0178id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0175R.C0178id.icon, 0);
                int backgroundSize2 = res.getDimensionPixelSize(C0175R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0175R.dimen.notification_big_circle_margin);
                int iconSize2 = res.getDimensionPixelSize(C0175R.dimen.notification_small_icon_size_as_large);
                ...
                contentView.setImageViewBitmap(C0175R.C0178id.icon, smallBit2);
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0175R.C0178id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0175R.C0178id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0175R.C0178id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0175R.C0178id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                int tooBig = res.getInteger(C0175R.integer.status_bar_notification_info_maxnum);
                if (this.mBuilder.mNumber > tooBig) {
                    contentView.setTextViewText(C0175R.C0178id.info, res.getString(C0175R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(C0175R.C0178id.info, f.format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0175R.C0178id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0175R.C0178id.info, 8);
                hasRightSide = false;
            }
            if (this.mBuilder.mSubText != null) {
                contentView.setTextViewText(C0175R.C0178id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0175R.C0178id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0175R.C0178id.text2, 0);
                    showLine2 = true;
                    i = 8;
                    if (showLine2) {
                        if (fitIn1U) {
                            float subTextSize = res.getDimensionPixelSize(C0175R.dimen.notification_subtext_size);
                            contentView.setTextViewTextSize(C0175R.C0178id.text, 0, subTextSize);
                        }
                        contentView.setViewPadding(C0175R.C0178id.line1, 0, 0, 0, 0);
                    }
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        if (this.mBuilder.mUseChronometer) {
                            contentView.setViewVisibility(C0175R.C0178id.chronometer, 0);
                            contentView.setLong(C0175R.C0178id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            contentView.setBoolean(C0175R.C0178id.chronometer, "setStarted", true);
                            if (this.mBuilder.mChronometerCountDown) {
                                contentView.setChronometerCountDown(C0175R.C0178id.chronometer, this.mBuilder.mChronometerCountDown);
                            }
                        } else {
                            contentView.setViewVisibility(C0175R.C0178id.time, 0);
                            contentView.setLong(C0175R.C0178id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        }
                        hasRightSide = true;
                    }
                    contentView.setViewVisibility(C0175R.C0178id.right_side, !hasRightSide ? 0 : i);
                    contentView.setViewVisibility(C0175R.C0178id.line3, showLine3 ? 0 : i);
                    return contentView;
                }
                i = 8;
                contentView.setViewVisibility(C0175R.C0178id.text2, 8);
            } else {
                i = 8;
            }
            showLine2 = false;
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0175R.C0177drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0175R.C0178id.notification_main_column);
            outerView.addView(C0175R.C0178id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0175R.C0178id.notification_main_column, 0);
            outerView.setViewPadding(C0175R.C0178id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0175R.C0178id.title, 8);
            outerView.setViewVisibility(C0175R.C0178id.text2, 8);
            outerView.setViewVisibility(C0175R.C0178id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0175R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0175R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0175R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0175R.C0178id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0175R.C0178id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0175R.C0178id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0175R.C0178id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0175R.layout.notification_action_tombstone : C0175R.layout.notification_action);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0175R.C0178id.action_image, createColoredBitmap(icon, this.mBuilder.mContext.getResources().getColor(C0175R.C0176color.notification_action_color_filter)));
            }
            button.setTextViewText(C0175R.C0178id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0175R.C0178id.action_container, action.actionIntent);
            }
            button.setContentDescription(C0175R.C0178id.action_container, action.title);
            return button;
        }
    }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m225clone() {
            WearableExtender that = new WearableExtender();
