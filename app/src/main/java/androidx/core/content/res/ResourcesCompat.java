...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public abstract void m206xb24343b7(int i);

        /* renamed from: onFontRetrieved */
        public abstract void m205x46c88379(Typeface typeface);
        ...
        public final void callbackSuccessAsync(final Typeface typeface, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.ResourcesCompat$FontCallback$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ResourcesCompat.FontCallback.this.m205x46c88379(typeface);
                }
            });
        }
        ...
        public final void callbackFailAsync(final int reason, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.ResourcesCompat$FontCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ResourcesCompat.FontCallback.this.m206xb24343b7(reason);
                }
            });
        }
    ...
    */
    private static Typeface loadFont(Context context, Resources wrapper, TypedValue value, int id, int style, FontCallback fontCallback, Handler handler, boolean isRequestFromLayoutInflator, boolean isCachedOnly) {
        ...
        String file4 = value.string.toString();
        if (!file4.startsWith("res/")) {
            if (fontCallback != null) {
                fontCallback.callbackFailAsync(-3, handler);
            }
            return null;
        }
        Typeface typeface = TypefaceCompat.findFromCache(resources, id, file4, value.assetCookie, style);
        if (typeface != null) {
            if (fontCallback != null) {
            ...
            try {
                try {
                    try {
                        try {
                            if (!file4.toLowerCase().endsWith(".xml")) {
                                resources = -3;
                                file = file4;
                                str = TAG;
                                ...
                                if (fontCallback != null) {
                                    try {
                                        ...
                                        e = e;
                                        Log.e(str, "Failed to read xml resource " + file, e);
                                        i2 = resources;
                                        if (fontCallback != null) {
                                        ...
                                        str2 = str;
                                        i = resources;
                                        Log.e(str2, "Failed to parse xml resource " + file2, e);
                                        i2 = i;
                                        if (fontCallback != null) {
                                        }
                                        return null;
                            ...
                            FontResourcesParserCompat.FamilyResourceEntry familyEntry = FontResourcesParserCompat.parse(rp, resources);
                            if (familyEntry == null) {
                                try {
                            ...
                            return TypefaceCompat.createFromResourcesFamilyXml(context, familyEntry, wrapper, id, file4, value.assetCookie, style, fontCallback, handler, isRequestFromLayoutInflator);
