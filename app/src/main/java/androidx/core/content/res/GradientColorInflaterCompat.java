...
public final class GradientColorInflaterCompat {
    ...
    public static Shader createFromXmlInner(Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0175R.styleable.GradientColor);
        float startX = TypedArrayUtils.getNamedFloat(a, parser, "startX", C0175R.styleable.GradientColor_android_startX, 0.0f);
        float startY = TypedArrayUtils.getNamedFloat(a, parser, "startY", C0175R.styleable.GradientColor_android_startY, 0.0f);
        float endX = TypedArrayUtils.getNamedFloat(a, parser, "endX", C0175R.styleable.GradientColor_android_endX, 0.0f);
        float endY = TypedArrayUtils.getNamedFloat(a, parser, "endY", C0175R.styleable.GradientColor_android_endY, 0.0f);
        float centerX = TypedArrayUtils.getNamedFloat(a, parser, "centerX", C0175R.styleable.GradientColor_android_centerX, 0.0f);
        float centerY = TypedArrayUtils.getNamedFloat(a, parser, "centerY", C0175R.styleable.GradientColor_android_centerY, 0.0f);
        int type = TypedArrayUtils.getNamedInt(a, parser, "type", C0175R.styleable.GradientColor_android_type, 0);
        int startColor = TypedArrayUtils.getNamedColor(a, parser, "startColor", C0175R.styleable.GradientColor_android_startColor, 0);
        boolean hasCenterColor = TypedArrayUtils.hasAttribute(parser, "centerColor");
        int centerColor = TypedArrayUtils.getNamedColor(a, parser, "centerColor", C0175R.styleable.GradientColor_android_centerColor, 0);
        int endColor = TypedArrayUtils.getNamedColor(a, parser, "endColor", C0175R.styleable.GradientColor_android_endColor, 0);
        int tileMode = TypedArrayUtils.getNamedInt(a, parser, "tileMode", C0175R.styleable.GradientColor_android_tileMode, 0);
        float gradientRadius = TypedArrayUtils.getNamedFloat(a, parser, "gradientRadius", C0175R.styleable.GradientColor_android_gradientRadius, 0.0f);
        a.recycle();
    ...
    private static ColorStops inflateChildElements(Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (type == 1 || ((depth = parser.getDepth()) < innerDepth && type == 3)) {
                ...
                TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0175R.styleable.GradientColorItem);
                boolean hasColor = a.hasValue(C0175R.styleable.GradientColorItem_android_color);
                boolean hasOffset = a.hasValue(C0175R.styleable.GradientColorItem_android_offset);
                if (!hasColor || !hasOffset) {
                    break;
                }
                int color = a.getColor(C0175R.styleable.GradientColorItem_android_color, 0);
                float offset = a.getFloat(C0175R.styleable.GradientColorItem_android_offset, 0.0f);
                a.recycle();
