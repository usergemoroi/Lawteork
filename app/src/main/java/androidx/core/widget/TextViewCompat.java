...
public final class TextViewCompat {
    ...
    public static void setCompoundDrawablesRelative(TextView textView, Drawable start, Drawable top2, Drawable end, Drawable bottom) {
        Api17Impl.setCompoundDrawablesRelative(textView, start, top2, end, bottom);
    }
    ...
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(TextView textView, Drawable start, Drawable top2, Drawable end, Drawable bottom) {
        Api17Impl.setCompoundDrawablesRelativeWithIntrinsicBounds(textView, start, top2, end, bottom);
    }
    ...
    public static class Api17Impl {
        ...
        static void setCompoundDrawablesRelative(TextView textView, Drawable start, Drawable top2, Drawable end, Drawable bottom) {
        ...
        static void setCompoundDrawablesRelativeWithIntrinsicBounds(TextView textView, int start, int top2, int end, int bottom) {
            textView.setCompoundDrawablesRelativeWithIntrinsicBounds(start, top2, end, bottom);
        }
