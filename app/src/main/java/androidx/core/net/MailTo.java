...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f63CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f64TO = "to";
    ...
    public static MailTo parse(String uri) throws ParseException {
        ...
        mailTo.mHeaders.put(f64TO, address);
        return mailTo;
    }
    ...
    public String getTo() {
        return this.mHeaders.get(f64TO);
    }

    public String getCc() {
        return this.mHeaders.get(f63CC);
    }
