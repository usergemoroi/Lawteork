...
public class KeyEventDispatcher {
    ...
    /* renamed from: androidx.core.view.KeyEventDispatcher$Component */
    /* loaded from: classes.dex */
    public interface InterfaceC0223Component {
    ...
    public static boolean dispatchKeyEvent(InterfaceC0223Component component, View root, Window.Callback callback, KeyEvent event) {
        if (component == null) {
            return false;
        }
