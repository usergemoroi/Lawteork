...
public final class ViewKt {
    ...
    public static /* synthetic */ void updatePaddingRelative$default(View $this$updatePaddingRelative_u24default, int start, int top2, int end, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
            start = $this$updatePaddingRelative_u24default.getPaddingStart();
        }
        if ((i & 2) != 0) {
            top2 = $this$updatePaddingRelative_u24default.getPaddingTop();
        }
        if ((i & 4) != 0) {
        ...
        $this$updatePaddingRelative_u24default.setPaddingRelative(start, top2, end, bottom);
    }
    ...
    public static /* synthetic */ void updatePadding$default(View $this$updatePadding_u24default, int left, int top2, int right, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
            left = $this$updatePadding_u24default.getPaddingLeft();
        }
        if ((i & 2) != 0) {
            top2 = $this$updatePadding_u24default.getPaddingTop();
        }
        if ((i & 4) != 0) {
        ...
        $this$updatePadding_u24default.setPadding(left, top2, right, bottom);
    }
    ...
    public static final Runnable postOnAnimationDelayed(View $this$postOnAnimationDelayed, long delayInMillis, final Function0<Unit> action) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewKt.m229postOnAnimationDelayed$lambda1(Function0.this);
            }
        };
    ...
    public static final void m229postOnAnimationDelayed$lambda1(Function0 action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
