...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f255top;
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int left, int top2, int right, int bottom) {
        return new Builder(this).setSystemWindowInsets(Insets.m204of(left, top2, right, bottom)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect systemWindowInsets) {
        return new Builder(this).setSystemWindowInsets(Insets.m203of(systemWindowInsets)).build();
    }

    @Deprecated
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f255top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f255top, insets.right, insets.bottom);
    }
    ...
    public static class Impl {
        ...
        WindowInsetsCompat inset(int left, int top2, int right, int bottom) {
            return CONSUMED;
        }
    ...
    public static class Impl20 extends Impl {
            ...
            switch (type) {
                case 1:
                    if (ignoreVisibility) {
                        ...
                        return Insets.m204of(0, Math.max(rootStable.f255top, getSystemWindowInsets().f255top), 0, 0);
                    }
                    Insets rootStable2 = getSystemWindowInsets();
                    return Insets.m204of(0, rootStable2.f255top, 0, 0);
                case 2:
                    if (ignoreVisibility) {
                        Insets rootStable3 = getRootStableInsets();
                        Insets stable = getStableInsets();
                        return Insets.m204of(Math.max(rootStable3.left, stable.left), 0, Math.max(rootStable3.right, stable.right), Math.max(rootStable3.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m204of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable4.bottom) {
                        return Insets.m204of(0, 0, 0, systemWindow2.bottom);
                    }
                    ...
                    if (insets != null && !insets.equals(Insets.NONE) && this.mRootViewVisibleInsets.bottom > rootStable4.bottom) {
                        return Insets.m204of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                    }
                    return Insets.NONE;
                case 16:
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m204of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m204of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
        ...
        private Insets getVisibleInsets(View rootView) {
            ...
            try {
                ...
                if (visibleRect != null) {
                    return Insets.m203of(visibleRect);
                }
                return null;
    ...
    private static class Impl21 extends Impl20 {
        ...
        final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m204of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public static Insets insetInsets(Insets insets, int left, int top2, int right, int bottom) {
        int newLeft = Math.max(0, insets.left - left);
        int newTop = Math.max(0, insets.f255top - top2);
        int newRight = Math.max(0, insets.right - right);
        int newBottom = Math.max(0, insets.bottom - bottom);
        if (newLeft == left && newTop == top2 && newRight == right && newBottom == bottom) {
            return insets;
        }
        return Insets.m204of(newLeft, newTop, newRight, newBottom);
    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f255top, insets.right, insets.bottom);
            }
        }
                ...
                try {
                    ...
                    if (attachInfo != null) {
                        ...
                        if (stableInsets != null && visibleInsets != null) {
                            WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m203of(stableInsets)).setSystemWindowInsets(Insets.m203of(visibleInsets)).build();
