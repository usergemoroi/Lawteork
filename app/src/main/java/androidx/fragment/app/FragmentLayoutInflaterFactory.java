...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if ("fragment".equals(name)) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0294R.styleable.Fragment);
            if (fname == null) {
                fname = a.getString(C0294R.styleable.Fragment_android_name);
            }
            int id = a.getResourceId(C0294R.styleable.Fragment_android_id, -1);
            String tag = a.getString(C0294R.styleable.Fragment_android_tag);
            a.recycle();
