...
public class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        switch (C03482.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()]) {
            case 1:
                break;
            case 2:
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0294R.C0297id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v(TAG, "requestFocus: Restoring focused view " + focusedView + ILogger.MSG_SEPARATOR + (success ? "succeeded" : "failed") + " on Fragment " + this.mFragment + " resulting in focused view " + this.mFragment.mView.findFocus());
            }
        }
