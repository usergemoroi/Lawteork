...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0169R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0169R.styleable.CoordinatorLayout, 0, C0169R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0169R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (defStyleAttr == 0) {
                saveAttributeDataForStyleable(context, C0169R.styleable.CoordinatorLayout, attrs, a, 0, C0169R.style.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, C0169R.styleable.CoordinatorLayout, attrs, a, defStyleAttr, 0);
            }
        }
        int keylineArrayRes = a.getResourceId(C0169R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0169R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        switch (anchorVgrav) {
            case 16:
                int top3 = anchorRect.top;
                top2 = top3 + (anchorRect.height() / 2);
                break;
            case 80:
                top2 = anchorRect.bottom;
                break;
            default:
                top2 = anchorRect.top;
                break;
        ...
        out.set(left, top2, left + childWidth, top2 + childHeight);
    }
    ...
    private void constrainChildRect(LayoutParams lp, Rect out, int childWidth, int childHeight) {
        ...
        int top2 = Math.max(getPaddingTop() + lp.topMargin, Math.min(out.top, ((height - getPaddingBottom()) - childHeight) - lp.bottomMargin));
        out.set(left, top2, left + childWidth, top2 + childHeight);
    }
    ...
    private void layoutChildWithKeyline(View child, int keyline, int layoutDirection) {
        ...
        int top3 = Math.max(getPaddingTop() + lp.topMargin, Math.min(top2, ((height - getPaddingBottom()) - childHeight) - lp.bottomMargin));
        child.layout(left2, top3, left2 + childWidth, top3 + childHeight);
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray a = context.obtainStyledAttributes(attrs, C0169R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0169R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0169R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0169R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0169R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0169R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0169R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            boolean hasValue = a.hasValue(C0169R.styleable.CoordinatorLayout_Layout_layout_behavior);
            this.mBehaviorResolved = hasValue;
            if (hasValue) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0169R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
