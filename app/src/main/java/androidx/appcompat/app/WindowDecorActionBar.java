...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0030R.C0033id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0030R.C0033id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0030R.C0033id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) decor.findViewById(C0030R.C0033id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0030R.styleable.ActionBar, C0030R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0030R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0030R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            currentTheme.resolveAttribute(C0030R.attr.actionBarWidgetTheme, outValue, true);
