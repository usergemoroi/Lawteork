...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0030R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0030R.styleable.AlertDialog, C0030R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0030R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0030R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0030R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0030R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0030R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0030R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0030R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0030R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x009f, code lost:
        r1 = r9.findViewById(androidx.appcompat.C0030R.C0033id.titleDividerNoCustom);
     */
    ...
    */
    private void setupView() {
        ...
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C0030R.C0033id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0030R.C0033id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0030R.C0033id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0030R.C0033id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0030R.C0033id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0030R.C0033id.topPanel);
        View customContentPanel = customPanel.findViewById(C0030R.C0033id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0030R.C0033id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer2 = contentPanel.findViewById(C0030R.C0033id.textSpacerNoButtons)) != null) {
            spacer2.setVisibility(0);
        }
        if (contentPanel != null && (spacer = contentPanel.findViewById(C0030R.C0033id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0030R.C0033id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0030R.C0033id.scrollIndicatorDown);
    ...
    /* loaded from: classes.dex */
    class C00372 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00372(View view, View view2) {
            this.val$top = view;
    ...
    /* loaded from: classes.dex */
    class RunnableC00383 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00383(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class C00394 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00394(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class RunnableC00405 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00405(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0030R.C0033id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0030R.C0033id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0030R.C0033id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0030R.C0033id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0030R.C0033id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0030R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0030R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0030R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
