...
public class AppCompatDialog extends ComponentDialog implements AppCompatCallback {
    ...
    private final KeyEventDispatcher.InterfaceC0223Component mKeyDispatcher;
    ...
    public AppCompatDialog(Context context, int theme) {
        ...
        this.mKeyDispatcher = new KeyEventDispatcher.InterfaceC0223Component() { // from class: androidx.appcompat.app.AppCompatDialog$$ExternalSyntheticLambda0
            @Override // androidx.core.view.KeyEventDispatcher.InterfaceC0223Component
    ...
    private static int getThemeResId(Context context, int themeId) {
        if (themeId == 0) {
            ...
            context.getTheme().resolveAttribute(C0030R.attr.dialogTheme, outValue, true);
