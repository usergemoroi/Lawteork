...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* loaded from: classes.dex */
    class C00471 implements Thread.UncaughtExceptionHandler {
        final /* synthetic */ Thread.UncaughtExceptionHandler val$defHandler;

        C00471(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    public Context attachBaseContext2(Context baseContext) {
        ...
        androidx.appcompat.view.ContextThemeWrapper wrappedContext = new androidx.appcompat.view.ContextThemeWrapper(baseContext, C0030R.style.Theme_AppCompat_Empty);
    ...
    */
    ...
    private ViewGroup createSubDecor() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0030R.styleable.AppCompatTheme);
        if (!a.hasValue(C0030R.styleable.AppCompatTheme_windowActionBar)) {
            a.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (a.getBoolean(C0030R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (a.getBoolean(C0030R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (a.getBoolean(C0030R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (a.getBoolean(C0030R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = a.getBoolean(C0030R.styleable.AppCompatTheme_android_windowIsFloating, false);
        a.recycle();
        ensureWindow();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0030R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0030R.attr.actionBarTheme, outValue, true);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0030R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) subDecor.findViewById(C0030R.C0033id.decor_content_parent);
            ...
            subDecor = this.mOverlayActionMode ? (ViewGroup) inflater.inflate(C0030R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) inflater.inflate(C0030R.layout.abc_screen_simple, (ViewGroup) null);
        }
        if (subDecor == null) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(subDecor, new OnApplyWindowInsetsListener() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                int top2 = insets.getSystemWindowInsetTop();
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(C0030R.C0033id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0030R.C0033id.action_bar_activity_content);
    ...
    /* loaded from: classes.dex */
    class C00504 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        C00504() {
        }
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0030R.styleable.AppCompatTheme);
        a.getValue(C0030R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0030R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0030R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0030R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0030R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0030R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0030R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0030R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0030R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0030R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0030R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(actionBarContext, (AttributeSet) null, C0030R.attr.actionModePopupWindowStyle);
                    this.mActionModePopup = popupWindow;
                    PopupWindowCompat.setWindowLayoutType(popupWindow, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0030R.attr.actionBarSize, outValue, true);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0030R.C0033id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    boolean dispatchKeyEvent(KeyEvent event) {
        View root;
        Object obj = this.mHost;
        if (((obj instanceof KeyEventDispatcher.InterfaceC0223Component) || (obj instanceof AppCompatDialog)) && (root = this.mWindow.getDecorView()) != null && KeyEventDispatcher.dispatchBeforeHierarchy(root, event)) {
            return true;
        }
    ...
    public View createView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            TypedArray a = this.mContext.obtainStyledAttributes(C0030R.styleable.AppCompatTheme);
            String viewInflaterClassName = a.getString(C0030R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    private void openPanel(PanelFeatureState st, KeyEvent event) {
        ...
        st.isHandled = false;
        WindowManager.LayoutParams lp3 = new WindowManager.LayoutParams(width, -2, st.f10x, st.f11y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.resolveAttribute(C0030R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0030R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    */
    final int updateStatusGuard(WindowInsetsCompat insets, Rect rectInsets) {
        ...
        int systemWindowInsetTop6 = 0;
        if (insets != null) {
            systemWindowInsetTop6 = insets.getSystemWindowInsetTop();
        } else if (rectInsets != null) {
            systemWindowInsetTop6 = rectInsets.top;
        }
        ...
        if (actionBarContextView == null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (newTopMargin <= 0 || this.mStatusGuard != null) {
                    systemWindowInsetTop4 = systemWindowInsetTop6;
                ...
                if (!this.mOverlayActionMode && showStatusGuard2) {
                    systemWindowInsetTop5 = 0;
                } else {
                    systemWindowInsetTop5 = systemWindowInsetTop4;
                }
                showStatusGuard = showStatusGuard2;
                systemWindowInsetTop3 = systemWindowInsetTop5;
                systemWindowInsetTop2 = 0;
            } else {
                int systemWindowInsetTop7 = systemWindowInsetTop6;
                if (mlp.topMargin == 0) {
                    systemWindowInsetTop2 = 0;
                    systemWindowInsetTop3 = systemWindowInsetTop7;
                } else {
                    mlpChanged = true;
                    systemWindowInsetTop2 = 0;
                    mlp.topMargin = 0;
            ...
            if (view != null) {
                view.setVisibility(showStatusGuard ? systemWindowInsetTop2 : 8);
            }
            return systemWindowInsetTop3;
        }
        systemWindowInsetTop3 = systemWindowInsetTop;
        view = this.mStatusGuard;
        if (view != null) {
        }
        return systemWindowInsetTop3;
    ...
    private void updateStatusGuardColor(View v) {
        ...
        if (lightStatusBar) {
            color = ContextCompat.getColor(this.mContext, C0030R.C0031color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(this.mContext, C0030R.C0031color.abc_decor_view_status_guard);
        }
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0030R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0030R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0030R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0030R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0030R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0030R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0030R.layout.abc_list_menu_item_layout);
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0030R.attr.homeAsUpIndicator});
