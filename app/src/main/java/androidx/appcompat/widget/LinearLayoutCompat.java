...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0030R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0030R.styleable.LinearLayoutCompat, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int index = a.getInt(C0030R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0030R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0030R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0030R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0030R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0030R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0030R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0030R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0030R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child != null && child.getVisibility() != 8 && hasDividerBeforeChildAt(i)) {
                ...
                int top2 = (child.getTop() - lp.topMargin) - this.mDividerHeight;
                drawHorizontalDivider(canvas, top2);
            }
        }
    ...
    void drawHorizontalDivider(Canvas canvas, int top2) {
    ...
    */
    ...
    void layoutVertical(int left, int top2, int right, int bottom) {
        int childTop;
        int paddingLeft;
        int gravity;
        int childLeft;
        ...
        switch (majorGravity) {
            case 16:
                ...
                childTop = childTop2 + (((bottom - top2) - this.mTotalLength) / 2);
                break;
            case 80:
                int childTop3 = getPaddingTop();
                childTop = ((childTop3 + bottom) - top2) - this.mTotalLength;
                break;
            default:
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    void layoutHorizontal(int left, int top2, int right, int bottom) {
        int childLeft;
        int start;
        int dir;
        int layoutDirection;
