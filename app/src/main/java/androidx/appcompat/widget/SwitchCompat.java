...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public SwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0030R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0030R.styleable.SwitchCompat, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0030R.styleable.SwitchCompat, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        Drawable drawable = a.getDrawable(C0030R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = a.getDrawable(C0030R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        setTextOnInternal(a.getText(C0030R.styleable.SwitchCompat_android_textOn));
        setTextOffInternal(a.getText(C0030R.styleable.SwitchCompat_android_textOff));
        this.mShowText = a.getBoolean(C0030R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.getDimensionPixelSize(C0030R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.getDimensionPixelSize(C0030R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.getDimensionPixelSize(C0030R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.getBoolean(C0030R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList thumbTintList = a.getColorStateList(C0030R.styleable.SwitchCompat_thumbTint);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0030R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList trackTintList = a.getColorStateList(C0030R.styleable.SwitchCompat_trackTint);
        if (trackTintList != null) {
            this.mTrackTintList = trackTintList;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0030R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int appearance = a.getResourceId(C0030R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TintTypedArray appearance = TintTypedArray.obtainStyledAttributes(context, resid, C0030R.styleable.TextAppearance);
        ColorStateList colors = appearance.getColorStateList(C0030R.styleable.TextAppearance_android_textColor);
        if (colors != null) {
            this.mTextColors = colors;
        } else {
            this.mTextColors = getTextColors();
        }
        int ts = appearance.getDimensionPixelSize(C0030R.styleable.TextAppearance_android_textSize, 0);
        if (ts != 0 && ts != this.mTextPaint.getTextSize()) {
            this.mTextPaint.setTextSize(ts);
            requestLayout();
        }
        int typefaceIndex = appearance.getInt(C0030R.styleable.TextAppearance_android_typeface, -1);
        int styleIndex = appearance.getInt(C0030R.styleable.TextAppearance_android_textStyle, -1);
        setSwitchTypefaceByIndex(typefaceIndex, styleIndex);
        boolean allCaps = appearance.getBoolean(C0030R.styleable.TextAppearance_textAllCaps, false);
        if (allCaps) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (switchText != null) {
            ...
            int top2 = ((switchInnerTop + switchInnerBottom) / 2) - (switchText.getHeight() / 2);
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C0030R.string.abc_capital_on);
            }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C0030R.string.abc_capital_off);
            }
            ViewCompat.setStateDescription(this, charSequence);
        }
    }
