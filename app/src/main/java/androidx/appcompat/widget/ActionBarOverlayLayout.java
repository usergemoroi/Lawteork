...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0030R.attr.actionBarSize, 16842841};
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!this.mOverlayMode && !stable) {
            ...
            Insets sysWindow = Insets.m204of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + topInset, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0);
    ...
    public void draw(Canvas c) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            if (this.mActionBarTop.getVisibility() == 0) {
                top2 = (int) (this.mActionBarTop.getBottom() + this.mActionBarTop.getTranslationY() + 0.5f);
            } else {
                top2 = 0;
            }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0030R.C0033id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0030R.C0033id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0030R.C0033id.action_bar));
        }
    }
