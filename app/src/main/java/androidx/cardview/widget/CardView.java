    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        CardViewDelegate cardViewDelegate = new CardViewDelegate() { // from class: androidx.cardview.widget.CardView.1
            ...
            public void setShadowPadding(int left, int top2, int right, int bottom) {
                CardView.this.mShadowBounds.set(left, top2, right, bottom);
                CardView cardView = CardView.this;
                CardView.super.setPadding(cardView.mContentPadding.left + left, CardView.this.mContentPadding.top + top2, CardView.this.mContentPadding.right + right, CardView.this.mContentPadding.bottom + bottom);
            }
        ...
        float radius = a.getDimension(C0128R.styleable.CardView_cardCornerRadius, 0.0f);
        ...
        rect.left = a.getDimensionPixelSize(C0128R.styleable.CardView_contentPaddingLeft, defaultPadding);
        rect.top = a.getDimensionPixelSize(C0128R.styleable.CardView_contentPaddingTop, defaultPadding);
        rect.right = a.getDimensionPixelSize(C0128R.styleable.CardView_contentPaddingRight, defaultPadding);
        rect.bottom = a.getDimensionPixelSize(C0128R.styleable.CardView_contentPaddingBottom, defaultPadding);
