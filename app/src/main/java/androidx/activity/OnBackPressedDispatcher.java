...
public final class OnBackPressedDispatcher {
        ...
        if (BuildCompat.isAtLeastT()) {
            this.mEnabledConsumer = new Consumer() { // from class: androidx.activity.OnBackPressedDispatcher$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    OnBackPressedDispatcher.this.m219lambda$new$0$androidxactivityOnBackPressedDispatcher((Boolean) obj);
                }
            };
    ...
    public /* synthetic */ void m219lambda$new$0$androidxactivityOnBackPressedDispatcher(Boolean aBoolean) {
        if (BuildCompat.isAtLeastT()) {
            updateBackInvokedCallbackState();
        }
    }
