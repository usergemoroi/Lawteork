...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01561 {
        ...
        static final /* synthetic */ int[] f47xbf6f0c8e;
        ...
        static {
            ...
            try {
                f47xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f47xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        switch (C01561.f47xbf6f0c8e[this.mRunType.ordinal()]) {
            case 1:
    ...
    void apply() {
        ...
        if (this.widget.mListAnchors[2].mTarget != null && this.widget.mListAnchors[3].mTarget != null) {
            ...
            DependencyNode top3 = this.widget.getParent().verticalRun.start;
            addTarget(this.start, top3, this.widget.getY());
            addTarget(this.end, this.start, 1, this.dimension);
            if (this.widget.hasBaseline()) {
                addTarget(this.baseline, this.start, 1, this.baselineDimension);
            }
