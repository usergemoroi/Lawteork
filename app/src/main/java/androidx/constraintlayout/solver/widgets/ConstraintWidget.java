...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + ILogger.MSG_SEPARATOR : "") + (this.mDebugName != null ? "id: " + this.mDebugName + ILogger.MSG_SEPARATOR : "") + "(" + this.f39mX + ", " + this.f40mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }

    public int getX() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f39mX;
        }
        return this.f39mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f40mY;
        }
        return this.f40mY;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public int getRootX() {
        return this.f39mX + this.mOffsetX;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public int getRootY() {
        return this.f40mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int goneMargin) {
        switch (C01531.f41x4c44d048[type.ordinal()]) {
            case 1:
        ...
        if (constraintFrom == ConstraintAnchor.Type.CENTER) {
            ...
            if (fromAnchor.isValidConnection(toAnchor)) {
                if (constraintFrom == ConstraintAnchor.Type.BASELINE) {
                    ConstraintAnchor top4 = getAnchor(ConstraintAnchor.Type.TOP);
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C01531.f41x4c44d048[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    public void addToSolver(LinearSystem system) {
        ...
        SolverVariable top5 = system.createObjectVariable(this.mTop);
        ...
        if (this.horizontalRun.start.resolved && this.horizontalRun.end.resolved && this.verticalRun.start.resolved && this.verticalRun.end.resolved) {
            ...
            system.addEquality(top5, this.verticalRun.start.value);
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && matchConstraintDefaultWidth2 == 3 && matchConstraintDefaultHeight2 == 3) {
                ...
                if (!useRatio) {
                    ...
                    if (this.verticalRun.start.resolved || !this.verticalRun.end.resolved) {
                        ...
                        linearSystem = system;
                        top4 = top3;
                        linearSystem.addEquality(top4, this.verticalRun.start.value);
                        bottom2 = bottom;
                    ...
                    if (applyVerticalConstraints) {
                        ...
                        if (this.mBaselineDistance > 0 || this.mVisibility == i) {
                            linearSystem.addEquality(baseline2, top4, getBaselineDistance(), i);
                            if (this.mBaseline.mTarget == null) {
                                if (this.mVisibility == i) {
                                    linearSystem.addEquality(baseline2, top4, r4, i);
                                }
                            } else {
                    ...
                    if (useRatio2) {
                        if (this.mResolvedDimensionRatioSide == i2) {
                            system.addRatio(bottom2, top4, right, left, this.mResolvedDimensionRatio, 8);
                        } else {
                            system.addRatio(right, left, bottom2, top4, this.mResolvedDimensionRatio, 8);
                        }
                    }
                    if (this.mCenter.isConnected()) {
    ...
    */
    private void applyConstraints(LinearSystem system, boolean isHorizontal, boolean parentWrapContent, boolean oppositeParentWrapContent, boolean isTerminal, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, boolean oppositeInChain, boolean inBarrier, int matchConstraintDefault, int oppositeMatchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        switch (C01531.f42xdde91696[dimensionBehaviour.ordinal()]) {
            case 1:
                variableSize4 = false;
                break;
            case 2:
    ...
    public static /* synthetic */ class C01531 {
        ...
        static {
            ...
            try {
                f42xdde91696[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f42xdde91696[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f42xdde91696[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f41x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f41x4c44d048[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void updateFromSolver(LinearSystem system) {
        ...
        int w = right - left;
        int h = bottom - top2;
        if (w < 0 || h < 0 || left == Integer.MIN_VALUE || left == Integer.MAX_VALUE || top2 == Integer.MIN_VALUE || top2 == Integer.MAX_VALUE || right == Integer.MIN_VALUE || right == Integer.MAX_VALUE || bottom == Integer.MIN_VALUE || bottom == Integer.MAX_VALUE) {
            left = 0;
            top2 = 0;
            right = 0;
            bottom = 0;
    ...
    public void copy(ConstraintWidget src, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f39mX = src.f39mX;
        this.f40mY = src.f40mY;
