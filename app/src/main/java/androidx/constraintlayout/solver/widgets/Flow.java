    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        for (int i6 = 0; i6 < listCount; i6++) {
            ...
            if (orientation == 0) {
                ...
                current2.setup(orientation, currentBottom2, top2, right, bottom, paddingLeft, paddingTop2, paddingRight2, paddingBottom2, max);
                paddingTop2 = 0;
                ...
                current2.setup(orientation, left2, top3, right, currentRight2, paddingLeft, paddingTop2, paddingRight2, paddingBottom2, max);
                left2 = currentRight;
                paddingLeft = 0;
