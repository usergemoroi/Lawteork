...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            return this.variable.f35id - v.f35id;
        }
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i = 0; i < 9; i++) {
                    result = result + this.variable.goalStrengthVector[i] + ILogger.MSG_SEPARATOR;
                }
            }
    ...
    private final void addToGoal(SolverVariable variable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i4 - 1].f35id > variable.f35id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.solver.PriorityGoalRow.1
                ...
                public int compare(SolverVariable variable1, SolverVariable variable2) {
                    return variable1.f35id - variable2.f35id;
                }
            });
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numGoals; i++) {
            ...
            result = result + this.accessor + ILogger.MSG_SEPARATOR;
        }
        return result;
    }
}
