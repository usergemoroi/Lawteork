...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState newState) {
        ...
        switch (C01412.f31xabc7e4ac[oldState.ordinal()]) {
            case 1:
            case 2:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C01412 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f32me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f32me.tracker = VelocityTracker.obtain();
            return f32me;
        }
    ...
    */
    ...
    public class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            String a = ILogger.MSG_SEPARATOR + (params.startToStart != -1 ? "SS" : "__");
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            String str3;
            String str4;
            StringBuilder append = new StringBuilder().append(ILogger.MSG_SEPARATOR);
            String str5 = "__";
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            String cName = title + ILogger.MSG_SEPARATOR + Debug.getName((View) c.getCompanionWidget());
            ...
            for (int i = 0; i < count; i++) {
                ...
                Log.v(MotionLayout.TAG, str + "  " + name + ILogger.MSG_SEPARATOR + child + ILogger.MSG_SEPARATOR + a2);
            }
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            Log.v(TAG, ILogger.MSG_SEPARATOR + Debug.getLocation() + ILogger.MSG_SEPARATOR + Debug.getName(this) + ILogger.MSG_SEPARATOR + Debug.getName(getContext(), this.mCurrentState) + ILogger.MSG_SEPARATOR + Debug.getName(child) + child.getLeft() + ILogger.MSG_SEPARATOR + child.getTop());
        }
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0164R.styleable.MotionLayout);
            int N = a.getIndexCount();
            boolean apply = true;
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0164R.styleable.MotionLayout_layoutDescription) {
                    int n = a.getResourceId(attr, -1);
                    this.mScene = new MotionScene(getContext(), this, n);
                } else if (attr == C0164R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = a.getResourceId(attr, -1);
                } else if (attr == C0164R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = a.getFloat(attr, 0.0f);
                    this.mInTransition = true;
                } else if (attr == C0164R.styleable.MotionLayout_applyMotionScene) {
                    apply = a.getBoolean(attr, apply);
                } else if (attr == C0164R.styleable.MotionLayout_showPaths) {
                    if (this.mDebugPath == 0) {
                        this.mDebugPath = a.getBoolean(attr, false) ? 2 : 0;
                    }
                } else if (attr == C0164R.styleable.MotionLayout_motionDebug) {
