...
public class MotionController {
    ...
    float getStartX() {
        return this.mStartMotionPath.f33x;
    }

    float getStartY() {
        return this.mStartMotionPath.f34y;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float getFinalX() {
        return this.mEndMotionPath.f33x;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float getFinalY() {
        return this.mEndMotionPath.f34y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f33x;
        start.top = this.mStartMotionPath.f34y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f33x;
        end.top = this.mEndMotionPath.f34y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f33x - this.mStartMotionPath.f33x;
        float dy = this.mEndMotionPath.f34y - this.mStartMotionPath.f34y;
        float startCenterX = this.mStartMotionPath.f33x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f34y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (points[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                ...
                values[i9][0] = points[i9].f33x;
                values[i9][1] = points[i9].f34y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f33x + " y: " + this.mStartMotionPath.f34y + " end: x: " + this.mEndMotionPath.f33x + " y: " + this.mEndMotionPath.f34y;
    }
    ...
    */
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f33x + ((this.mEndMotionPath.f33x - this.mStartMotionPath.f33x) * position);
            float float_t = this.mStartMotionPath.f34y + ((this.mEndMotionPath.f34y - this.mStartMotionPath.f34y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f33x - this.mStartMotionPath.f33x;
        float dTop = this.mEndMotionPath.f34y - this.mStartMotionPath.f34y;
