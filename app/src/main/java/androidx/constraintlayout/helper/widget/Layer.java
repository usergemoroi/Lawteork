...
public class Layer extends ConstraintHelper {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0164R.styleable.ConstraintLayout_Layout_android_visibility) {
                    this.mApplyVisibilityOnAttach = true;
                } else if (attr == C0164R.styleable.ConstraintLayout_Layout_android_elevation) {
    ...
    public void updatePostLayout(ConstraintLayout container) {
        ...
        int top2 = ((int) this.mComputedMinY) - getPaddingTop();
