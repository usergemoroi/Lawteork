...
public class Explode extends Visibility {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        int bottom = view.getHeight() + top2;
        transitionValues.values.put(PROPNAME_SCREEN_BOUNDS, new Rect(left, top2, right, bottom));
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        float endX = startX;
        float endY = startY;
        int[] interruptedPosition = (int[]) startValues.view.getTag(C0498R.C0501id.transition_position);
