...
public class TransitionValues {
    ...
    public String toString() {
        ...
        String returnValue2 = (returnValue + "    view = " + this.view + ShellUtils.COMMAND_LINE_END) + "    values:";
        for (String s : this.values.keySet()) {
            returnValue2 = returnValue2 + "    " + s + ": " + this.values.get(s) + ShellUtils.COMMAND_LINE_END;
        }
        return returnValue2;
    }
}
