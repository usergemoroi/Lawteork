...
class ViewUtilsBase {
    ...
    public void setTransitionAlpha(View view, float alpha) {
        Float savedAlpha = (Float) view.getTag(C0498R.C0501id.save_non_transition_alpha);
        if (savedAlpha != null) {
    ...
    public void saveNonTransitionAlpha(View view) {
        if (view.getTag(C0498R.C0501id.save_non_transition_alpha) == null) {
            view.setTag(C0498R.C0501id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }

    public void clearNonTransitionAlpha(View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0498R.C0501id.save_non_transition_alpha, null);
        }
    }
    ...
    public void setLeftTopRightBottom(View v, int left, int top2, int right, int bottom) {
        ...
        if (method != null) {
            try {
                method.invoke(v, Integer.valueOf(left), Integer.valueOf(top2), Integer.valueOf(right), Integer.valueOf(bottom));
