...
public class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        protected ViewParent invalidateChildInParentFast(int left, int top2, Rect dirty) {
            if ((this.mHostView instanceof ViewGroup) && sInvalidateChildInParentFastMethod != null) {
                try {
                    int[] offset = new int[2];
                    getOffset(offset);
                    sInvalidateChildInParentFastMethod.invoke(this.mHostView, Integer.valueOf(left), Integer.valueOf(top2), dirty);
                    return null;
