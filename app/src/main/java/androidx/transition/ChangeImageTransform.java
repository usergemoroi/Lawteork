...
public class ChangeImageTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        Rect bounds = new Rect(left, top2, right, bottom);
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        ...
        if (image.getIntrinsicWidth() > 0 && image.getIntrinsicHeight() > 0) {
            switch (C04873.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
                case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C04873 {
