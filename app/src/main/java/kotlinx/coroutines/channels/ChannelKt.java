...
public final class ChannelKt {
    ...
    public static final <T> Object m1761onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> function1) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1767exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m1760onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> function1) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m1767exceptionOrNullimpl($this$onClosed));
        }
