...
@DebugMetadata(m62c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m61f = "Deprecated.kt", m60i = {0, 0, 1, 1}, m59l = {136, 139}, m58m = "single", m57n = {"$this$consume$iv", "iterator", "$this$consume$iv", "single"}, m56s = {"L$0", "L$1", "L$0", "L$1"})
