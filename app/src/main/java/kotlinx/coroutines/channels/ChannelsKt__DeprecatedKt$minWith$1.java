...
@DebugMetadata(m62c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m61f = "Deprecated.kt", m60i = {0, 0, 0, 1, 1, 1, 1}, m59l = {434, 436}, m58m = "minWith", m57n = {"comparator", "$this$consume$iv", "iterator", "comparator", "$this$consume$iv", "iterator", "min"}, m56s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"})
