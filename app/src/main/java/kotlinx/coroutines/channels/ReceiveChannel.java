...
public interface ReceiveChannel<E> {
    ...
    Object mo1756receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1757tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo1757tryReceivePtdJZtk();
            if (ChannelResult.m1773isSuccessimpl(result)) {
                return (E) ChannelResult.m1769getOrThrowimpl(result);
            }
            Throwable m1767exceptionOrNullimpl = ChannelResult.m1767exceptionOrNullimpl(result);
            if (m1767exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1767exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object mo1756receiveCatchingJP2dKIU;
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (receiveChannel$receiveOrNull$12.label) {
                        case 0:
                            ...
                            mo1756receiveCatchingJP2dKIU = receiveChannel.mo1756receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$12);
                            if (mo1756receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            break;
                        case 1:
                            ResultKt.throwOnFailure($result);
                            mo1756receiveCatchingJP2dKIU = ((ChannelResult) $result).m1775unboximpl();
                            break;
                        default:
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    return ChannelResult.m1768getOrNullimpl(mo1756receiveCatchingJP2dKIU);
                }
            }
