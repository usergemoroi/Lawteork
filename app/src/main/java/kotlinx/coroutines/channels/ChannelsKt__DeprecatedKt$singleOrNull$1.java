...
@DebugMetadata(m62c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m61f = "Deprecated.kt", m60i = {0, 0, 1, 1}, m59l = {149, 152}, m58m = "singleOrNull", m57n = {"$this$consume$iv", "iterator", "$this$consume$iv", "single"}, m56s = {"L$0", "L$1", "L$0", "L$1"})
