...
@DebugMetadata(m62c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m61f = "Deprecated.kt", m60i = {0, 0, 0, 0}, m59l = {487}, m58m = "lastIndexOf", m57n = {"element", "lastIndex", "index", "$this$consume$iv$iv"}, m56s = {"L$0", "L$1", "L$2", "L$3"})
