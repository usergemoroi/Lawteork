...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1756receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof AbstractChannel$receiveCatching$1) {
            ...
            if ((abstractChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (abstractChannel$receiveCatching$12.label) {
                    case 0:
                        ...
                        if (result != AbstractChannelKt.POLL_FAILED) {
                            return result instanceof Closed ? ChannelResult.Companion.m1776closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.Companion.m1778successJP2dKIU(result);
                        }
                ...
                return ((ChannelResult) receiveSuspend).m1775unboximpl();
            }
        }
    ...
    public final Object mo1757tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1777failurePtdJZtk() : result instanceof Closed ? ChannelResult.Companion.m1776closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.Companion.m1778successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1795constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1803remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1800plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1755onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    protected void mo1755onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
        if (value instanceof Closed) {
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1763boximpl(ChannelResult.Companion.m1776closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
            ...
            Object $this$toResult$iv = ChannelResult.m1763boximpl(value instanceof Closed ? ChannelResult.Companion.m1776closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.Companion.m1778successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m267constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
                } else if (result != AbstractChannelKt.POLL_FAILED) {
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1763boximpl(ChannelResult.Companion.m1778successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m267constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m267constructorimpl(ChannelResult.m1763boximpl(ChannelResult.Companion.m1776closedJP2dKIU(closed.closeCause))));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1763boximpl(ChannelResult.Companion.m1778successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1763boximpl(ChannelResult.Companion.m1776closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        return;
                    default:
                        return;
                }
