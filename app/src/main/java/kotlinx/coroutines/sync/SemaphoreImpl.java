...
public final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                        m1807constructorimpl = SegmentOrClosed.m1807constructorimpl(ConcurrentLinkedListKt.CLOSED);
                        break;
                    }
                    ...
                    m1807constructorimpl = SegmentOrClosed.m1807constructorimpl(cur$iv$iv);
                    curTail = s$iv2;
                    break;
                }
            }
            s$iv = m1807constructorimpl;
            if (SegmentOrClosed.m1812isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1810getSegmentimpl(s$iv);
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    z = false;
                    break;
                } else if (C0137xc40028dd.m207m(tail$FU, this, cur$iv$iv2, to$iv$iv)) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1810getSegmentimpl(s$iv);
        i2 = SemaphoreKt.SEGMENT_SIZE;
        int i3 = (int) (enqIdx % i2);
        if (!ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m49m(segment.acquirers, i3, null, cancellableContinuation)) {
            expected$iv = SemaphoreKt.PERMIT;
            value$iv = SemaphoreKt.TAKEN;
            if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m49m(segment.acquirers, i3, expected$iv, value$iv)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        do {
            ...
            while (true) {
                ...
                if (cur$iv$iv2.getId() >= to$iv$iv.getId()) {
                    ...
                    continue;
                    break;
                } else if (C0137xc40028dd.m207m(head$FU, this, cur$iv$iv2, to$iv$iv)) {
                    if (cur$iv$iv2.decPointers$kotlinx_coroutines_core()) {
                        cur$iv$iv2.remove();
                    }
                    z = true;
        ...
        if (value$iv2 == null) {
            ...
            return !ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m49m(segment.acquirers, i4, expected$iv, value$iv);
        }
