            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m267constructorimpl(successfulResult$kotlinx_coroutines_core));
                    }
                    ...
                    try {
                        ...
                        handleFatalException(fatalException, Result.m270exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
