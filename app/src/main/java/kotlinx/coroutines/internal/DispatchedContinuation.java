...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        while (true) {
            ...
            if (state == null) {
                ...
                if (C0137xc40028dd.m207m(_reusableCancellableContinuation$FU, this, state, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
    ...
    public final Throwable tryReleaseClaimedContinuation(CancellableContinuation<?> cancellableContinuation) {
        do {
            ...
            if (state != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (state instanceof Throwable) {
                    if (!C0137xc40028dd.m207m(_reusableCancellableContinuation$FU, this, state, null)) {
        ...
        } while (!C0137xc40028dd.m207m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cancellableContinuation));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable cause) {
        while (true) {
            ...
            if (Intrinsics.areEqual(state, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (C0137xc40028dd.m207m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo1804dispatch(context, this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    */
    public final void resumeCancellableWith(Object result, Function1<? super Throwable, Unit> function1) {
        ?? r1;
        Job job$iv;
        boolean z;
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo1804dispatch(getContext(), this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
        ...
        if (job$iv != null) {
            ...
            if (!job$iv.isActive()) {
                ...
                resumeWith(Result.m267constructorimpl(ResultKt.createFailure(cause$iv)));
                z = true;
                if (z) {
