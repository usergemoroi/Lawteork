...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    /* loaded from: classes.dex */
    public static final class C10012<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ Function2 $predicate$inlined;
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* compiled from: Emitters.kt */
        @Metadata(m69k = 3, m68mv = {1, 6, 0}, m66xi = 176)
        @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", m61f = "Transform.kt", m60i = {0, 0}, m59l = {223, 223}, m58m = "emit", m57n = {"value", "$this$filterNot_u24lambda_u2d1"}, m56s = {"L$0", "L$1"})
        /* renamed from: kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2$1 */
        /* loaded from: classes.dex */
        public static final class C10021 extends ContinuationImpl {
            Object L$0;
            Object L$1;
            int label;
            /* synthetic */ Object result;

            public C10021(Continuation continuation) {
                super(continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C10012.this.emit(null, this);
            }
        }

        public C10012(FlowCollector flowCollector, Function2 function2) {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof C10021) {
                ...
                if ((c10021.label & Integer.MIN_VALUE) != 0) {
                    ...
                    c100212 = c10021;
                    Object $result = c100212.result;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    switch (c100212.label) {
                        case 0:
                            ResultKt.throwOnFailure($result);
                            $this$filterNot_u24lambda_u2d1 = this.$this_unsafeFlow;
                            Function2 function2 = this.$predicate$inlined;
                            c100212.L$0 = t;
                            c100212.L$1 = $this$filterNot_u24lambda_u2d1;
                            c100212.label = 1;
                            invoke = function2.invoke(t, c100212);
                            ...
                            if (!((Boolean) invoke).booleanValue()) {
                                ...
                                c100212.L$1 = null;
                                c100212.label = 2;
                                if ($this$filterNot_u24lambda_u2d1.emit(t2, c100212) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                            }
                            return Unit.INSTANCE;
                        case 1:
                            Object value = c100212.L$0;
                            ResultKt.throwOnFailure($result);
                            t2 = value;
                            $this$filterNot_u24lambda_u2d1 = (FlowCollector) c100212.L$1;
                            invoke = $result;
                            if (!((Boolean) invoke).booleanValue()) {
                            }
                            return Unit.INSTANCE;
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C10012(collector, this.$predicate$inlined), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C10012(collector, this.$predicate$inlined), $completion);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
