...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m61f = "Limit.kt", m60i = {0}, m59l = {153}, m58m = "invokeSuspend", m57n = {"collector$iv"}, m56s = {"L$0"})
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                C0983xdf1aa1b6 collector$iv2 = new C0983xdf1aa1b6(this.$transform, $this$flow);
                try {
            ...
            case 1:
                collector$iv = (C0983xdf1aa1b6) this.L$0;
                try {
                    ResultKt.throwOnFailure($result);
