...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2", m61f = "Zip.kt", m60i = {}, m59l = {292, 292}, m58m = "invokeSuspend", m57n = {}, m56s = {})
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return flowCollector.emit($result, flowKt__ZipKt$combine$6$2) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
            case 1:
                ResultKt.throwOnFailure($result);
