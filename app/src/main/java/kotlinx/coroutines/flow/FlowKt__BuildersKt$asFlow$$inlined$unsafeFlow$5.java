...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m61f = "Builders.kt", m60i = {0}, m59l = {115}, m58m = "collect", m57n = {"$this$asFlow_u24lambda_u2d7"}, m56s = {"L$0"})
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C09651) {
            ...
            if ((c09651.label & Integer.MIN_VALUE) != 0) {
                ...
                c096512 = c09651;
                Object $result = c096512.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (c096512.label) {
                    case 0:
                        ...
                        break;
                    case 1:
                        it = (Iterator) c096512.L$1;
                        $this$asFlow_u24lambda_u2d7 = (FlowCollector) c096512.L$0;
                        ResultKt.throwOnFailure($result);
                        break;
                    default:
                ...
                while (it.hasNext()) {
                    c096512.L$0 = $this$asFlow_u24lambda_u2d7;
                    c096512.L$1 = it;
                    c096512.label = 1;
                    Object value = $this$asFlow_u24lambda_u2d7.emit(it.next(), c096512);
