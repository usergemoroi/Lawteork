...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$1$1", m61f = "Zip.kt", m60i = {}, m59l = {262, 262}, m58m = "invokeSuspend", m57n = {}, m56s = {})
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                return flowCollector.emit($result, flowKt__ZipKt$combineUnsafe$1$1) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
            case 1:
                ResultKt.throwOnFailure($result);
