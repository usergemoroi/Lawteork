...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m61f = "Delay.kt", m60i = {}, m59l = {280}, m58m = "invokeSuspend", m57n = {}, m56s = {})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C09721<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C09721(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.$this_sample.collect(new C09721($this$produce), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
