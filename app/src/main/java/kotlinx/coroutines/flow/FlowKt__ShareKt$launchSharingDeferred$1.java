...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1", m61f = "Share.kt", m60i = {}, m59l = {340}, m58m = "invokeSuspend", m57n = {}, m56s = {})
...
public final class FlowKt__ShareKt$launchSharingDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    this.label = 1;
                    return this.$upstream.collect(new C09931(state, $this$launch, this.$result), this) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                } catch (Throwable th) {
                    e = th;
    ...
    /* loaded from: classes.dex */
    public static final class C09931<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ CoroutineScope $$this$launch;
        final /* synthetic */ CompletableDeferred<StateFlow<T>> $result;
        final /* synthetic */ Ref.ObjectRef<MutableStateFlow<T>> $state;

        C09931(Ref.ObjectRef<MutableStateFlow<T>> objectRef, CoroutineScope coroutineScope, CompletableDeferred<StateFlow<T>> completableDeferred) {
