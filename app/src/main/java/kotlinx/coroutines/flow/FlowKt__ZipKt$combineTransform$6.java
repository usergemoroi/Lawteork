...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", m61f = "Zip.kt", m60i = {}, m59l = {251}, m58m = "invokeSuspend", m57n = {}, m56s = {})
...
public final class FlowKt__ZipKt$combineTransform$6<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C10301<T> extends Lambda implements Function0<T[]> {
        final /* synthetic */ Flow<T>[] $flows;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C10301(Flow<? extends T>[] flowArr) {
            super(0);
            this.$flows = flowArr;
        }
    ...
    @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", m61f = "Zip.kt", m60i = {}, m59l = {251}, m58m = "invokeSuspend", m57n = {}, m56s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* loaded from: classes.dex */
    public static final class C10312<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C10312(Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C10312> continuation) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C10312 c10312 = new C10312(this.$transform, continuation);
            c10312.L$0 = flowCollector;
            c10312.L$1 = tArr;
            return c10312.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                if (CombineKt.combineInternal($this$flow, flowArr, new C10301(this.$flows), new C10312(this.$transform, null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal($this$flow, flowArr, new C10301(this.$flows), new C10312(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
