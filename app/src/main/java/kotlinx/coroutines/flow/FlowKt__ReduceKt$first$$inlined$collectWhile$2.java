...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m61f = "Reduce.kt", m60i = {0, 0}, m59l = {143}, m58m = "emit", m57n = {"this", "it"}, m56s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1 */
    /* loaded from: classes.dex */
    public static final class C09891 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C09891(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        Object invoke;
        Object it;
        if (continuation instanceof C09891) {
            c09891 = (C09891) continuation;
            if ((c09891.label & Integer.MIN_VALUE) != 0) {
                c09891.label -= Integer.MIN_VALUE;
                c098912 = c09891;
                Object $result = c098912.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                z = true;
                switch (c098912.label) {
                    case 0:
                        ...
                        c098912.L$0 = flowKt__ReduceKt$first$$inlined$collectWhile$2;
                        c098912.L$1 = t;
                        c098912.label = 1;
                        InlineMarker.mark(6);
                        invoke = function2.invoke(t, c098912);
                        InlineMarker.mark(7);
                    ...
                    case 1:
                        it = (T) c098912.L$1;
                        flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c098912.L$0;
                        ResultKt.throwOnFailure($result);
                        invoke = $result;
                        break;
                    default:
                ...
                if (((Boolean) invoke).booleanValue()) {
                    flowKt__ReduceKt$first$$inlined$collectWhile$2.$result$inlined.element = (T) it;
                    z = false;
                }
                if (z) {
        ...
        c09891 = new C09891(continuation);
        c098912 = c09891;
        Object $result2 = c098912.result;
