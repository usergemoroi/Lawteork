...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8 implements Flow<Long> {
    ...
    @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8", m61f = "Builders.kt", m60i = {0}, m59l = {115}, m58m = "collect", m57n = {"$this$asFlow_u24lambda_u2d15"}, m56s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8$1 */
    /* loaded from: classes.dex */
    public static final class C09681 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        Object L$1;
        ...
        public C09681(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super Long> flowCollector, Continuation<? super Unit> continuation) {
        ...
        int i2;
        long[] jArr2;
        FlowCollector $this$asFlow_u24lambda_u2d152;
        if (continuation instanceof C09681) {
            ...
            if ((c09681.label & Integer.MIN_VALUE) != 0) {
                ...
                c096812 = c09681;
                Object $result = c096812.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (c096812.label) {
                    case 0:
                        ...
                        break;
                    case 1:
                        $i$f$forEach = c096812.I$1;
                        i2 = c096812.I$0;
                        jArr2 = (long[]) c096812.L$1;
                        ResultKt.throwOnFailure($result);
                        $this$asFlow_u24lambda_u2d152 = (FlowCollector) c096812.L$0;
                        jArr = jArr2;
                        i = i2;
                        $this$asFlow_u24lambda_u2d15 = $this$asFlow_u24lambda_u2d152;
                        break;
                    default:
                ...
                if (i < $i$f$forEach) {
                    ...
                    c096812.L$0 = $this$asFlow_u24lambda_u2d15;
                    c096812.L$1 = jArr;
                    c096812.I$0 = i2;
                    c096812.I$1 = $i$f$forEach;
                    c096812.label = 1;
                    if ($this$asFlow_u24lambda_u2d15.emit(boxLong, c096812) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    jArr2 = jArr;
                    $this$asFlow_u24lambda_u2d152 = $this$asFlow_u24lambda_u2d15;
                    jArr = jArr2;
                    i = i2;
                    $this$asFlow_u24lambda_u2d15 = $this$asFlow_u24lambda_u2d152;
                    if (i < $i$f$forEach) {
