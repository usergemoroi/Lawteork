...
public final /* synthetic */ class FlowKt__ZipKt {
    ...
    public static final <T1, T2, R> Flow<R> flowCombineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> function4) {
        ...
        return FlowKt.flow(new C1019xd7c321e6(flows$iv, null, function4));
    }
    ...
    public static final <T1, T2, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> function4) {
        Flow[] flows$iv = {flow, flow2};
        return FlowKt.flow(new C1021xd7c321e7(flows$iv, null, function4));
    }
    ...
    public static final <T1, T2, T3, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, final Function4<? super T1, ? super T2, ? super T3, ? super Continuation<? super R>, ? extends Object> function4) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1
            ...
            public Object collect(FlowCollector collector, Continuation $completion) {
                ...
                nullArrayFactory$FlowKt__ZipKt = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
                Object combineInternal = CombineKt.combineInternal(collector, flowArr, nullArrayFactory$FlowKt__ZipKt, new C10142(null, function4), $completion);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }

            /* compiled from: Zip.kt */
            @Metadata(m71d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@¨\u0006\u0007"}, m70d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m69k = 3, m68mv = {1, 6, 0}, m66xi = 48)
            @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1$2", m61f = "Zip.kt", m60i = {}, m59l = {333, 333}, m58m = "invokeSuspend", m57n = {}, m56s = {})
            /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1$2 */
            /* loaded from: classes.dex */
            public static final class C10142 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                public C10142(Continuation continuation, Function4 function4) {
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C10142 c10142 = new C10142(continuation, this.$transform$inlined);
                    c10142.L$0 = flowCollector;
                    c10142.L$1 = objArr;
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c10142.L$0 = null;
                            c10142.label = 2;
                            return flowCollector.emit($result, c10142) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            c10142 = this;
                            ...
                            c10142.L$0 = null;
                            c10142.label = 2;
                            if (flowCollector.emit($result, c10142) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
    ...
    public static final <T1, T2, T3, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Function5<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super Continuation<? super Unit>, ? extends Object> function5) {
        ...
        return FlowKt.flow(new C1023xd7c321e8(flows$iv, null, function5));
    }
    ...
    public static final <T1, T2, T3, T4, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, final Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super R>, ? extends Object> function5) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2
            ...
            public Object collect(FlowCollector collector, Continuation $completion) {
                ...
                Flow[] flowArr = flows$iv;
                nullArrayFactory$FlowKt__ZipKt = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
                Object combineInternal = CombineKt.combineInternal(collector, flowArr, nullArrayFactory$FlowKt__ZipKt, new C10152(null, function5), $completion);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }

            /* compiled from: Zip.kt */
            @Metadata(m71d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@¨\u0006\u0007"}, m70d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m69k = 3, m68mv = {1, 6, 0}, m66xi = 48)
            @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2$2", m61f = "Zip.kt", m60i = {}, m59l = {333, 333}, m58m = "invokeSuspend", m57n = {}, m56s = {})
            /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2$2 */
            /* loaded from: classes.dex */
            public static final class C10152 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C10152(Continuation continuation, Function5 function5) {
                    super(3, continuation);
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C10152 c10152 = new C10152(continuation, this.$transform$inlined);
                    c10152.L$0 = flowCollector;
                    c10152.L$1 = objArr;
                    return c10152.invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c10152.L$0 = null;
                            c10152.label = 2;
                            return flowCollector.emit($result, c10152) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            c10152 = this;
                            ...
                            c10152.L$0 = null;
                            c10152.label = 2;
                            if (flowCollector.emit($result, c10152) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
    ...
    public static final <T1, T2, T3, T4, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Function6<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super Unit>, ? extends Object> function6) {
        ...
        return FlowKt.flow(new C1025xd7c321e9(flows$iv, null, function6));
    }
    ...
    public static final <T1, T2, T3, T4, T5, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Flow<? extends T5> flow5, final Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super R>, ? extends Object> function6) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3
            ...
            public Object collect(FlowCollector collector, Continuation $completion) {
                ...
                Flow[] flowArr = flows$iv;
                nullArrayFactory$FlowKt__ZipKt = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
                Object combineInternal = CombineKt.combineInternal(collector, flowArr, nullArrayFactory$FlowKt__ZipKt, new C10162(null, function6), $completion);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }

            /* compiled from: Zip.kt */
            @Metadata(m71d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@¨\u0006\u0007"}, m70d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m69k = 3, m68mv = {1, 6, 0}, m66xi = 48)
            @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3$2", m61f = "Zip.kt", m60i = {}, m59l = {333, 333}, m58m = "invokeSuspend", m57n = {}, m56s = {})
            /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3$2 */
            /* loaded from: classes.dex */
            public static final class C10162 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C10162(Continuation continuation, Function6 function6) {
                    super(3, continuation);
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C10162 c10162 = new C10162(continuation, this.$transform$inlined);
                    c10162.L$0 = flowCollector;
                    c10162.L$1 = objArr;
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c10162.L$0 = null;
                            c10162.label = 2;
                            return flowCollector.emit($result, c10162) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            c10162 = this;
                            ...
                            c10162.L$0 = null;
                            c10162.label = 2;
                            if (flowCollector.emit($result, c10162) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
    ...
    public static final <T1, T2, T3, T4, T5, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Flow<? extends T5> flow5, Function7<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super Unit>, ? extends Object> function7) {
        ...
        return FlowKt.flow(new C1027xd7c321ea(flows$iv, null, function7));
    }
