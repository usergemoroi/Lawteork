...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    */
    public static /* synthetic */ Object collect$suspendImpl(SharedFlowImpl sharedFlowImpl, FlowCollector flowCollector, Continuation continuation) {
        ...
        FlowCollector collector2;
        Object newValue;
        SharedFlowSlot slot2;
        SharedFlowImpl sharedFlowImpl4;
        FlowCollector collector3;
        try {
                ...
                if ((sharedFlowImpl$collect$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (sharedFlowImpl$collect$12.label) {
                        case 0:
                            ...
                            collectorJob = (Job) sharedFlowImpl$collect$12.getContext().get(Job.Key);
                            collector2 = collector;
                            sharedFlowImpl3 = sharedFlowImpl2;
                            flowCollector = slot;
                            break;
                        case 1:
                            SharedFlowSlot sharedFlowSlot = (SharedFlowSlot) sharedFlowImpl$collect$12.L$2;
                            FlowCollector flowCollector2 = (FlowCollector) sharedFlowImpl$collect$12.L$1;
                            SharedFlowImpl sharedFlowImpl6 = (SharedFlowImpl) sharedFlowImpl$collect$12.L$0;
                            ResultKt.throwOnFailure($result);
                            collector = flowCollector2;
                            sharedFlowImpl2 = sharedFlowImpl6;
                            slot = sharedFlowSlot;
                            collectorJob = (Job) sharedFlowImpl$collect$12.getContext().get(Job.Key);
                            collector2 = collector;
                            sharedFlowImpl3 = sharedFlowImpl2;
                            ...
                            break;
                        case 2:
                            collectorJob = (Job) sharedFlowImpl$collect$12.L$3;
                        ...
                        case 3:
                            ...
                            FlowCollector flowCollector3 = (FlowCollector) sharedFlowImpl$collect$12.L$1;
                            SharedFlowImpl sharedFlowImpl8 = (SharedFlowImpl) sharedFlowImpl$collect$12.L$0;
                            ResultKt.throwOnFailure($result);
                            collector3 = flowCollector3;
                            sharedFlowImpl4 = sharedFlowImpl8;
                            slot2 = sharedFlowSlot3;
                            collector2 = collector3;
                            sharedFlowImpl3 = sharedFlowImpl4;
                            flowCollector = slot2;
                            break;
                        default:
                    ...
                    do {
                        newValue = sharedFlowImpl3.tryTakeValue(flowCollector);
                        if (newValue == SharedFlowKt.NO_VALUE) {
                            sharedFlowImpl$collect$12.L$0 = sharedFlowImpl3;
                            sharedFlowImpl$collect$12.L$1 = collector2;
                            sharedFlowImpl$collect$12.L$2 = flowCollector;
                            sharedFlowImpl$collect$12.L$3 = collectorJob;
                            ...
                            Object emit = collector2.emit(newValue, sharedFlowImpl$collect$12);
                            collector3 = collector2;
                            sharedFlowImpl4 = sharedFlowImpl3;
                            slot2 = flowCollector;
                    ...
                    } while (sharedFlowImpl3.awaitValue(flowCollector, sharedFlowImpl$collect$12) != coroutine_suspended);
                    return coroutine_suspended;
                }
            }
            switch (sharedFlowImpl$collect$12.label) {
            ...
            sharedFlowImpl3.freeSlot(flowCollector);
            throw th;
        }
        sharedFlowImpl$collect$1 = new SharedFlowImpl$collect$1(sharedFlowImpl, continuation);
        sharedFlowImpl$collect$12 = sharedFlowImpl$collect$1;
        Object $result2 = sharedFlowImpl$collect$12.result;
        coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
    }
    ...
    */
        ...
        if (maxResumeCount <= 0) {
            ...
            while (true) {
                ...
                if (emitter == SharedFlowKt.NO_VALUE) {
                    ...
                    Emitter emitter2 = (Emitter) emitter;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: SharedFlow.kt */
    @Metadata(m71d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B1\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0002\u0010\u000bJ\b\u0010\f\u001a\u00020\nH\u0016R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, m70d2 = {"Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;", "Lkotlinx/coroutines/DisposableHandle;", "flow", "Lkotlinx/coroutines/flow/SharedFlowImpl;", "index", "", "value", "", "cont", "Lkotlin/coroutines/Continuation;", "", "(Lkotlinx/coroutines/flow/SharedFlowImpl;JLjava/lang/Object;Lkotlin/coroutines/Continuation;)V", "dispose", "kotlinx-coroutines-core"}, m69k = 1, m68mv = {1, 6, 0}, m66xi = 48)
    /* loaded from: classes.dex */
