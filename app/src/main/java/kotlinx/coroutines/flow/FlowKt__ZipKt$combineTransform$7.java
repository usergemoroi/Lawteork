...
@DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", m61f = "Zip.kt", m60i = {}, m59l = {StatusLine.HTTP_PERM_REDIRECT}, m58m = "invokeSuspend", m57n = {}, m56s = {})
...
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* compiled from: Zip.kt */
    @Metadata(m71d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0004\u0010\u0000\u001a\f\u0012\u0006\u0012\u0004\u0018\u0001H\u0002\u0018\u00010\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m70d2 = {"<anonymous>", "", "T", "R", "invoke", "()[Ljava/lang/Object;"}, m69k = 3, m68mv = {1, 6, 0}, m66xi = 176)
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$1 */
    /* loaded from: classes.dex */
    public static final class C10321<T> extends Lambda implements Function0<T[]> {
        final /* synthetic */ Flow<T>[] $flowArray;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10321(Flow<T>[] flowArr) {
            super(0);
            this.$flowArray = flowArr;
        }
    ...
    @DebugMetadata(m62c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m61f = "Zip.kt", m60i = {}, m59l = {StatusLine.HTTP_PERM_REDIRECT}, m58m = "invokeSuspend", m57n = {}, m56s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* loaded from: classes.dex */
    public static final class C10332<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C10332(Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C10332> continuation) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C10332 c10332 = new C10332(this.$transform, continuation);
            c10332.L$0 = flowCollector;
            c10332.L$1 = tArr;
            return c10332.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Intrinsics.needClassReification();
                this.label = 1;
                if (CombineKt.combineInternal($this$flow, flowArr, new C10321(this.$flowArray), new C10332(this.$transform, null), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal($this$flow, flowArr, new C10321(this.$flowArray), new C10332(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
