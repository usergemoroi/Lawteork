...
public interface Delay {
    ...
    void mo1805scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation);
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(Delay delay, long time, Continuation<? super Unit> continuation) {
            ...
            delay.mo1805scheduleResumeAfterDelay(time, it);
