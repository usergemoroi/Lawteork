...
.method private static unsealByDexFile(Landroid/content/Context;)Z
    ...
    invoke-direct {v4, v3}, Ldalvik/system/DexFile;-><init>(Ljava/io/File;)V

    .line 61
    .local v4, "dexFile":Ldalvik/system/DexFile;
    const-string v5, "me.weishu.reflection.BootstrapClass"

    const/4 v6, 0x0

    invoke-virtual {v4, v5, v6}, Ldalvik/system/DexFile;->loadClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;

    move-result-object v5

    .line 62
    .local v5, "bootstrapClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    const-string v7, "exemptAll"
    ...
    .line 63
    .local v7, "exemptAll":Ljava/lang/reflect/Method;
    ...
    .line 54
    .end local v5    # "bootstrapClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v7    # "exemptAll":Ljava/lang/reflect/Method;
    .local v4, "fos":Ljava/io/FileOutputStream;
    :catchall_0
    move-exception v5
    ...
    .end local v3    # "code":Ljava/io/File;
    .end local v4    # "fos":Ljava/io/FileOutputStream;
    ...
    .restart local v3    # "code":Ljava/io/File;
